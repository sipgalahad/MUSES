...
namespace CodeX.Muses.Web.ControlPanel.Program
{
    public partial class UserRolesList : BasePageList
    {
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetUserRoleRowIndex(filterExpression, keyValue) + 1;
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            if (isCountPageCount)
            {
                rowCount = BusinessLayer.GetUserRoleRowCount(filterExpression);
        ...
        {
            url = ResolveUrl("~/Program/ControlPanel/UserManagement/UserRoles/UserRolesEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/ControlPanel/UserManagement/UserRoles/UserRolesEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
