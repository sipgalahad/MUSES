<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserRolesReportEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanelHQ.Program.UserRolesReportEntryCtl" %>
        ...
        <tr>            
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent" style="width:70%">
                    ...
                    <tr>
                        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Role")%></label></td>
                        <td><asp:TextBox ID="txtRoleName" ReadOnly="true" Width="100%" runat="server" /></td>
                    </tr>  
                    <tr>
