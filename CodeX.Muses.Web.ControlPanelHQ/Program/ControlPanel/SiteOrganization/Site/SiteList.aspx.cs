...
{
    public partial class SiteList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.ControlPanelHQ.SITE_INFORMATION;
        }

        public override void SetFilterParameter(ref string[] fieldListText, ref string[] fieldListValue)
        {
            fieldListText = new string[] { "Site ID", "Site Name", "Short Name" };
            fieldListValue = new string[] { "SiteID", "SiteName", "ShortName" };
        }
