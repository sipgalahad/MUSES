<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SiteItemQuickPicksEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanelHQ.Program.SiteItemQuickPicksEntryCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                                ...
                                OnRowDataBound="grdView_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ItemName1" HeaderText="Nama" ItemStyle-CssClass="tdItemName" />
                                    </Columns>
                                    <EmptyDataTemplate>
