<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPSitePageTrxVisit.master" AutoEventWireup="true" 
    CodeBehind="SiteItemEntry.aspx.cs" Inherits="CodeX.Muses.Web.ControlPanelHQ.Program.SiteItemEntry" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#divQuickPicks').click(function () {
                showLoadingPanel();
                var url = ResolveUrl('~/Program/ControlPanel/SiteOrganization/Site/SiteItem/SiteItemQuickPicksEntryCtl.ascx');
        ...
        $('#<%=grdView.ClientID %> .divDetailDelete').live('click', function () {
            ...
            showToastConfirmation('Are You Sure Want To Delete?', function (result) {
                if (result) {
                    ...
                    $('#<%=hdnEntryID.ClientID %>').val(entity.SiteItemID);
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        ...
                                        <input type="hidden" value="<%#Eval("SiteItemID") %>" bindingfield="SiteItemID" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
