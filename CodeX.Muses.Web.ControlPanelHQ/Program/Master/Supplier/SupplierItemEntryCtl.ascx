<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SupplierItemEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.SupplierItemEntryCtl" %>
...
<script type="text/javascript" id="dxss_serviceunitsiteentryctl">
    ...
    $('#lblItem.lblLink').live('click', function () {
        ...
        var filterExpression = "ItemID NOT IN (SELECT ItemID FROM SupplierItem WHERE BusinessPartnerID = " + businessPartnerID + " AND IsDeleted = 0) AND IsDeleted = 0";
