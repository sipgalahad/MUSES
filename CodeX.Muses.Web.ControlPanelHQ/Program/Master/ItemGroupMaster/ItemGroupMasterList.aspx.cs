...
namespace CodeX.Muses.Web.ControlPanel.Program
{
    public partial class ItemGroupMasterList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.ControlPanelHQ.ITEM_GROUP_MASTER;
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            if (isCountPageCount)
            {
                rowCount = BusinessLayer.GetvItemGroupMasterRowCount(filterExpression);
        ...
        {
            url = ResolveUrl(string.Format("~/Program/Master/ItemGroupMaster/ItemGroupMasterEntry.aspx?id=add|{0}", cboItemType.Value));
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/ItemGroupMaster/ItemGroupMasterEntry.aspx?id=edit|{0}", hdnID.Value));
                return true;
            }
            return false;
        }
