...
{
    public partial class SyncProcessList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.ControlPanelHQ.SYNC_PROCESS;
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            if (isCountPageCount)
            {
                rowCount = BusinessLayer.GetvDBSyncInfoDtRowCount(filterExpression);
        ...
        protected override bool OnSyncRecord(ref string errMessage)
        {
            try
            {
                ClientAdapter.Instance.SendMessage(cboSite.Value.ToString(), hdnID.Value);
                return true;
            }
            catch (Exception ex)
            {
