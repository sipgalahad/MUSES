...
{
    public partial class MPSitePageTrxVisit : BaseMP
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                ((SiteBannerDtCtl)ctlBanner).InitializeBanner();
                ((MPBaseDetailPageTrx)Master).SetTitleText(((SiteBannerDtCtl)ctlBanner).OnGetTitleText());
            }
        }
    }
}