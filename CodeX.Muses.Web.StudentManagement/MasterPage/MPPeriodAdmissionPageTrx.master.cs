...
{
    public partial class MPPeriodAdmissionPageTrx : BaseMP
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string parentCode = Constant.MenuCode.StudentManagement.PERIOD_ADMISSION_PAGE;
                ...
                ((PeriodAdmissionBannerDtCtl)ctlBanner).InitializeBanner();
                ((MPBaseDetailPageTrx)Master).SetTitleText(((PeriodAdmissionBannerDtCtl)ctlBanner).OnGetTitleText());
            }
        }
    }
}