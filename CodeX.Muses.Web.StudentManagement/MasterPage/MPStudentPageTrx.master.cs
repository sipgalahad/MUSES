...
{
    public partial class MPStudentPageTrx : BaseMP
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string parentCode = Constant.MenuCode.StudentManagement.STUDENT_PAGE;
                ...
                ((StudentBannerDtCtl)ctlBanner).InitializeBanner();
                ((MPBaseDetailPageTrx)Master).SetTitleText(((StudentBannerDtCtl)ctlBanner).OnGetTitleText());
            }
        }
    }
}