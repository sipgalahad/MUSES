...
{
    public partial class MPTeacherAbsencePageTrxVisit : BaseMP
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string parentCode = Constant.MenuCode.StudentManagement.TEACHER_ABSENCE;
                ...
                ((TeacherAbsenceBannerDtCtl)ctlBanner).InitializeBanner();
                ((MPBaseDetailPageTrx)Master).SetTitleText(((TeacherAbsenceBannerDtCtl)ctlBanner).OnGetTitleText());
            }
        }
    }
}