...
{
    public partial class MPClassStudentPageTrx : BaseMP
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string parentCode = Constant.MenuCode.StudentManagement.CLASS_STUDENT_PAGE;
                ...
                ((ClassStudentBannerDtCtl)ctlBanner).InitializeBanner();
                ((MPBaseDetailPageTrx)Master).SetTitleText(((ClassStudentBannerDtCtl)ctlBanner).OnGetTitleText());
            }
        }
    }
}