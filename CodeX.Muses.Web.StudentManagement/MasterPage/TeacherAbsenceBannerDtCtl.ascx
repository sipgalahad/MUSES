<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TeacherAbsenceBannerDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.MasterPage.TeacherAbsenceBannerDtCtl" %>
