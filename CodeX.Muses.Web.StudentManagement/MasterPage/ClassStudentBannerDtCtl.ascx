<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClassStudentBannerDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.MasterPage.ClassStudentBannerDtCtl" %>
