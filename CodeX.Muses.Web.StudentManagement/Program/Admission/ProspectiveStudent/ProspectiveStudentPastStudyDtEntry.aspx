<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.master" AutoEventWireup="true" 
    CodeBehind="ProspectiveStudentPastStudyDtEntry.aspx.cs" Inherits="CodeX.Muses.Web.StudentManagement.Program.ProspectiveStudentPastStudyDtEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPFrame" runat="server">
    <script type="text/javascript">
        ...
        $('#<%=grdView.ClientID %> .divDetailEdit').live('click', function () {
            ...
            $('#<%=hdnEntryID.ClientID %>').val(entity.ProspectiveStudentPastStudyID);
                    ...
                    <dx:PanelContent ID="PanelContent1" runat="server">
                        <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                            ...
                            <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="ProspectiveStudentPastStudyID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            ...
                                            <input type="hidden" value="<%#Eval("ProspectiveStudentPastStudyID") %>" bindingfield="ProspectiveStudentPastStudyID" />
