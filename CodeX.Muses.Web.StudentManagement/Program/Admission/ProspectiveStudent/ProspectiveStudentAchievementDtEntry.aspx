<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPFrame.master" AutoEventWireup="true" 
    CodeBehind="ProspectiveStudentAchievementDtEntry.aspx.cs" Inherits="CodeX.Muses.Web.StudentManagement.Program.ProspectiveStudentAchievementDtEntry" %>
        ...
        $('#<%=grdView.ClientID %> .divDetailDelete').live('click', function () {
            ...
            showToastConfirmation('Are You Sure Want To Delete?', function (result) {
                if (result) {
                    ...
                    $('#<%=hdnEntryID.ClientID %>').val(entity.ProspectiveStudentAchievementID);
                    ...
                    <dx:PanelContent ID="PanelContent1" runat="server">
                        <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                            ...
                            <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="ProspectiveStudentAchievementID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            ...
                                            <input type="hidden" value="<%#Eval("ProspectiveStudentAchievementID") %>" bindingfield="ProspectiveStudentAchievementID" />
