...
{
    public partial class TeacherSubstitutionEntry : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.StudentManagement.TSB_TEACHER_SUBSTITUTION;
        }
        ...
        private void BindGridView()
        {
            ...
            lstTeacherSubstitution = BusinessLayer.GetvTeacherSubstitutionList(string.Format("TeacherAbsenceID = {0} AND SchoolDate IS NULL AND IsDeleted = 0", AppSession.TeacherAbsenceID));
        ...
        protected override bool OnCustomButtonClick(string type, ref string errMessage)
        {
            ...
            try
            {
                List<TeacherSubstitution> lstTeacherSubstitution = BusinessLayer.GetTeacherSubstitutionList(string.Format("TeacherAbsenceID = {0} AND SchoolDate IS NULL AND IsDeleted = 0", AppSession.TeacherAbsenceID), ctx);
