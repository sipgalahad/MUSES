<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="TeacherAbsenceList.aspx.cs" Inherits="CodeX.Muses.Web.StudentManagement.Program.TeacherAbsenceList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkTeacherSubstitution a').live('click', function () {
            var id = $(this).closest('tr').find('.keyField').html();
            var url = ResolveUrl('~/Program/TeacherAbsence/TeacherAbsencePageLauncher.aspx?id=' + id);
            openWindowPopup(url, 'TeacherAbsence', '1300', '650');
        });
    </script>
