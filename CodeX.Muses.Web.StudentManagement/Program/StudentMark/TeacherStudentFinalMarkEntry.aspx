<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="TeacherStudentFinalMarkEntry.aspx.cs" Inherits="CodeX.Muses.Web.StudentManagement.Program.TeacherStudentFinalMarkEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lblDetail').live('click', function () {
            ...
            var id = $('#<%=hdnClassID.ClientID %>').val() + '|' + $(this).closest('tr').find('.keyField').html() + '|' + tacPeriodSection.getValue();
