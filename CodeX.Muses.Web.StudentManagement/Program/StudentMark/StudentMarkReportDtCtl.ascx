<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StudentMarkReportDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.Program.StudentMarkReportDtCtl" %>
...
<asp:Repeater ID="rptPrint" runat="server">
    <ItemTemplate>
        <input type="radio" name="rboRegistrationPrint" value="1" reportcode='<%# Eval("ReportCode")%>' /><%# Eval("ReportName")%><br />
    </ItemTemplate>
</asp:Repeater>
