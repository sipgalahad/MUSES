<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClassStudentNoteViewDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.Program.ClassStudentNoteViewDtCtl" %>
            ...
            <dx:PanelContent ID="PanelContent2" runat="server">
                <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                    <Columns>
                        ...
                        <asp:BoundField DataField="SubjectName" HeaderText="Pelajaran" HeaderStyle-Width="150px" />
