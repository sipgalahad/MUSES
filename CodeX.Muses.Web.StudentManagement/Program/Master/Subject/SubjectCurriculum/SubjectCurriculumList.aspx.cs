...
{
    public partial class SubjectCurriculumList : BasePageTrx
    {
        public override string OnGetMenuCode()
        {
            return Constant.MenuCode.StudentManagement.SBM_SUBJECT_CURRICULUM;
        }
        ...
        {
            string filterExpression = string.Format("SubjectCurriculumID = {0} AND IsDeleted = 0", AppSession.SubjectCurriculumID);
