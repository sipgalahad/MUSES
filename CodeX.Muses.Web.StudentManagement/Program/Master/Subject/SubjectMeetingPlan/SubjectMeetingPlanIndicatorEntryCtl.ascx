<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubjectMeetingPlanIndicatorEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.Program.SubjectMeetingPlanIndicatorEntryCtl" %>
...
<div style="padding:10px;">
    ...
    <input type="hidden" id="hdnSubjectMeetingPlanHdID" runat="server" value="" />
