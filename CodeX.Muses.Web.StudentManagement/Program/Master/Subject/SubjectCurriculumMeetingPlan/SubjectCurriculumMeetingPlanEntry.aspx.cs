    ...
    public partial class SubjectCurriculumMeetingPlanEntry : BasePageTrx
    {
        public override string OnGetMenuCode()
        {
            if (AppSession.SubjectCurriculumID > 0)
                return Constant.MenuCode.StudentManagement.SBM_SUBJECT_CURRICULUM_MEETING_PLAN;
            return Constant.MenuCode.StudentManagement.SB_SUBJECT_CURRICULUM_MEETING_PLAN;
        }
