<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubjectMatterClassTypeEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.Program.SubjectMatterClassTypeEntryCtl" %>
...
<div style="padding:10px;">
    ...
    <input type="hidden" id="hdnSubjectMatterID" runat="server" value="" />
