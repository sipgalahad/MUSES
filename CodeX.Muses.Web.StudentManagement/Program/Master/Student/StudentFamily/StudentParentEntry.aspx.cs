...
namespace CodeX.Muses.Web.StudentManagement.Program
{
    public partial class StudentParentEntry : BasePageTrx
    {
        ...
        private void ControlToEntity(StudentFamily entityFather, StudentFamily entityMother, Address homeAddressFather, Address homeAddressMother, Address officeAddressFather, Address officeAddressMother)
        {
            #region Father
        ...
        private bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            try
            {
                ...
                homeAddressFather.GCAddressType = Constant.AddressType.STUDENT_FAMILY;
                ...
                officeAddressFather.GCAddressType = Constant.AddressType.STUDENT_FAMILY_OFFICE;
                ...
                homeAddressMother.GCAddressType = Constant.AddressType.STUDENT_FAMILY;
                ...
                officeAddressMother.GCAddressType = Constant.AddressType.STUDENT_FAMILY_OFFICE;
        ...
        private bool OnSaveEditRecord(ref string errMessage)
        {
            ...
            try
            {
                bool isAddFatherAddress = false;
                bool isAddMotherAddress = false;
                ...
                if (homeAddressFather == null)
                {
                    isAddFatherAddress = true;
                    homeAddressFather.GCAddressType = Constant.AddressType.STUDENT_FAMILY;
                    homeAddressFather.AddressID = string.Format("{0}{1}", hdnHomeAddressPrefix.Value, entityFather.FamilyID);
                    addressDao.Insert(homeAddressFather);
                }

                if (homeAddressMother == null)
                {
                    isAddMotherAddress = true;
                    homeAddressMother.GCAddressType = Constant.AddressType.STUDENT_FAMILY;
                    homeAddressMother.AddressID = string.Format("{0}{1}", hdnHomeAddressPrefix.Value, entityMother.FamilyID);
                    addressDao.Insert(homeAddressMother);
                }
                ...
                if (isAddFatherAddress)
                    addressDao.Insert(homeAddressFather);
                else
                    addressDao.Update(homeAddressFather);

                if (isAddMotherAddress)
                    addressDao.Insert(homeAddressMother);
                else
