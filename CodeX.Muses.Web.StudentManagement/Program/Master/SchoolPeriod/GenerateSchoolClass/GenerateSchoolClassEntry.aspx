<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPSchoolPeriodPageTrxVisit.master" AutoEventWireup="true" 
    CodeBehind="GenerateSchoolClassEntry.aspx.cs" Inherits="CodeX.Muses.Web.StudentManagement.Program.GenerateSchoolClassEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('.lnkGenerate').live('click', function () {
            var id = $(this).closest('tr').find('.keyField').html();
            var url = ResolveUrl("~/Program/Master/SchoolPeriod/GenerateSchoolClass/GenerateSchoolClassEntryCtl.ascx");
