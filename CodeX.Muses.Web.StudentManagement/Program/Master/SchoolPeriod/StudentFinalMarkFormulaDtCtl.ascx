<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StudentFinalMarkFormulaDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.Program.StudentFinalMarkFormulaDtCtl" %>
...
<div>
    <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
        <Columns>
            ...
            <asp:BoundField DataField="ListTaskType" HeaderText="Tipe Tugas" HeaderStyle-Width="500px" />
