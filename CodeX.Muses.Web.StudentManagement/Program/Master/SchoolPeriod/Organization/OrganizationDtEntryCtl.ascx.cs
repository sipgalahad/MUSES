...
namespace CodeX.Muses.Web.StudentManagement.Program
{
    public partial class OrganizationDtEntryCtl : BaseViewPopupCtl
    {
        ...
        {
            hdnID.Value = param;
            OrganizationHd entity = BusinessLayer.GetOrganizationHd(Convert.ToInt32(hdnID.Value));
            txtHeaderText.Text = string.Format("{0} - {1}", entity.OrganizationCode, entity.OrganizationName);
            ...
            Helper.SetControlEntrySetting(tacStudentCoordinator, new ControlEntrySetting(true, true, true), "mpTrxPopup");
        }
        ...
        {
            grdView.DataSource = BusinessLayer.GetvOrganizationDtList(string.Format("OrganizationID = {0} ORDER BY DisplayOrder ASC", hdnID.Value));
            grdView.DataBind();
        }
        ...
        private void ControlToEntity(OrganizationDt entity)
        {
            entity.DisplayOrder = Convert.ToInt16(txtDisplayOrder.Text);
            entity.StudentCoordinatorID = Convert.ToInt32(hdnStudentCoordinatorID.Value);
        ...
        private bool OnSaveAddRecordEntityDt(ref string errMessage)
        {
            ...
            try
            {
                ...
                entity.OrganizationID = Convert.ToInt32(hdnID.Value);
        ...
        private bool OnDeleteEntityDt(ref string errMessage)
        {
            try
            {
                OrganizationDt entity = BusinessLayer.GetOrganizationDt(Convert.ToInt32(hdnEntryID.Value));
                entity.IsDeleted = true;
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.UpdateOrganizationDt(entity);
                return true;
            }
            catch (Exception ex)
            {
