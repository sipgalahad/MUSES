<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClassSubjectExtracurricularDtEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.Program.ClassSubjectExtracurricularDtEntryCtl" %>
                ...
                <fieldset id="fsTrxPopup">
                    <table id="tblSelectedItem" class="grdView notAllowSelect" cellspacing="0" rules="all" >
                        <tr id="trHeader2">
                            ...
                            <th style="width:80px" class="thCenter"><%=GetLabel("Pembina Utama")%></th> 
                        </tr>
