<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPSchoolPeriodPageTrxVisit.master" AutoEventWireup="true" 
    CodeBehind="ClassStudentExtracurricularEntry.aspx.cs" Inherits="CodeX.Muses.Web.StudentManagement.Program.ClassStudentExtracurricularEntry" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#divQuickPicks').click(function () {
                showLoadingPanel();
                var url = ResolveUrl('~/Program/Master/SchoolPeriod/ClassStudentExtracurricular/ClassStudentExtracurricularQuickPicksEntryCtl.ascx');
