<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPSchoolPeriodPageTrxVisit.master" AutoEventWireup="true" 
    CodeBehind="PeriodGradeEntry.aspx.cs" Inherits="CodeX.Muses.Web.StudentManagement.Program.PeriodGradeEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('#<%=grdView.ClientID %> .divDetailEdit').live('click', function () {
            ...
            $('#<%=hdnGCGrade.ClientID %>').val(entity.GCGrade);
            $('#<%=txtGrade.ClientID %>').val(entity.Grade);
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtGrade" runat="server" ReadOnly="true" Width="200px" />
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                        ...
                        <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult" OnRowDataBound="grdView_RowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Kurikulum" HeaderStyle-Width="200px">
                                    <ItemTemplate>
                                        <div id="divCurriculum" runat="server"></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        ...
                                        <input type="hidden" value="<%#Eval("Grade") %>" bindingfield="Grade" />
                                        <input type="hidden" id="hdnCurriculumID" runat="server" bindingfield="CurriculumID" />
                                        <input type="hidden" id="hdnCurriculumName" runat="server"  bindingfield="CurriculumName" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
