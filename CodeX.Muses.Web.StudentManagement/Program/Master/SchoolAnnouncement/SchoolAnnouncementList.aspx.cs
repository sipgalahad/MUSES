...
{
    public partial class SchoolAnnouncementList : BasePageList
    {
        ...
        {
            fieldListText = new string[] { "Title" };
            fieldListValue = new string[] { "Title" };
        }
        ...
        {
            url = ResolveUrl(string.Format("~/Program/Master/SchoolAnnouncement/SchoolAnnouncementEntry.aspx?id=add|{0}", cboSite.Value));
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/SchoolAnnouncement/SchoolAnnouncementEntry.aspx?id=edit|{0}", hdnID.Value));
                return true;
            }
            return false;
        }
