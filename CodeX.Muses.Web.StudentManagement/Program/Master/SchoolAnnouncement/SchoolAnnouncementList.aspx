<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="SchoolAnnouncementList.aspx.cs" Inherits="CodeX.Ottimo.Web.ControlPanel.Program.SchoolAnnouncementList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkTemplateContent a').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/Master/SchoolAnnouncement/TemplateContentViewCtl.ascx");
