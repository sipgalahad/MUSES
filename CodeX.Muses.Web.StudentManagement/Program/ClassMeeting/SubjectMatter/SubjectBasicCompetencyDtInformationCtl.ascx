<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubjectBasicCompetencyDtInformationCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.Program.SubjectBasicCompetencyDtInformationCtl" %>
