<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubjectIndicatorInformationCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.Program.SubjectIndicatorInformationCtl" %>
...
<div style="height:440px; overflow-y:auto">
    ...
    <table class="tblEntryContent" style="width:70%">
        ...
        <tr>
            <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Kompetensi Dasar")%></label></td>
