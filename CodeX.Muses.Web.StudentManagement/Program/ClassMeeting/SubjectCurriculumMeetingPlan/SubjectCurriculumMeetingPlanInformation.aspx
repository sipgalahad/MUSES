...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('.divDetailEdit').live('click', function () {
            ...
            $row = $(this).closest('tr');
            var id = $('#<%=hdnSubjectID.ClientID %>').val() + '|' + subjectCurriculumID + '|' + curriculumDtID + '|' + parentID + '|' + $row.find('.hdnSubjectCurriculumMeetingPlanID').val();
    ...
    <style type="text/css">
        ...
        .tdName div, .tdReference div         { -ms-word-break: break-all;word-break: break-all;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;max-width: 340px; white-space: nowrap }
    </style>
