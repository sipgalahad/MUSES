<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubjectCurriculumSyllabusInformationDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.StudentManagement.Program.SubjectCurriculumSyllabusInformationDtCtl" %>
                    ...
                    <fieldset id="fsEntryPopup" style="margin: 0">
                        <table style="width: 100%" cellpadding="0" cellspacing="1">
                            ...
                            <tr id="trCode" runat="server">
                                ...
                                <td><asp:TextBox ID="txtSubjectCurriculumSyllabusCode" ReadOnly="true" runat="server" Width="100px" /></td>
                            </tr>
                            <tr>
                                <td style="padding-top:5px; vertical-align: top" class="tdLabel"><label class="lblMandatory"><%=GetLabel("Teks")%></label></td>
                                <td><asp:TextBox ID="txtSubjectCurriculumSyllabusName" ReadOnly="true" runat="server" Width="450px" TextMode="MultiLine" Rows="5" /></td>
                            </tr>
                            <tr id="trReferenceID" runat="server">
                                <td class="tdLabel"><label class="lblMandatory" id="lblReference" runat="server"></label></td>
                                <td><dxe:ASPxComboBox ID="cboReferenceID" ClientEnabled="false" ClientInstanceName="cboReferenceID" runat="server" Width="200px"  /></td>
                            </tr>
                            <tr>
                                <td style="padding-top:5px; vertical-align: top" class="tdLabel"><label class="lblNormal"><%=GetLabel("Keterangan")%></label></td>
                                <td><asp:TextBox ID="txtRemarks" runat="server" ReadOnly="true" Width="450px" TextMode="MultiLine" Rows="5" /></td>
                            </tr>
                        </table>
                    </fieldset>
                </div>
