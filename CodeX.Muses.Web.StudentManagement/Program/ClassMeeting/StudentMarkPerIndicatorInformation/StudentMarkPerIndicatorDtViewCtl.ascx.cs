...
{
    public partial class StudentMarkPerIndicatorDtViewCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            lstClassSubjectTaskIndicator = BusinessLayer.GetvClassSubjectTaskIndicatorList(string.Format("ClassSubjectID = {0} AND CurriculumMarkTypeID = {1} AND IsDeleted = 0", AppSession.ClassSubject.ClassSubjectID, hdnCurriculumMarkTypeID.Value));
            ...
            string filterExpression = string.Format("PeriodSectionID = {0} AND ClassSubjectID = {1} AND CurriculumMarkTypeID = {2}", AppSession.ClassSubject.PeriodSectionID, AppSession.ClassSubject.ClassSubjectID, hdnCurriculumMarkTypeID.Value);
