...
{
    public partial class ClassAttendanceSummaryDtCtl : BaseViewPopupCtl
    {
        ...
        {
            string filterExpression = string.Format("ClassSubjectID = {0} AND StudentID = {1} AND GCAttendanceStatus = '{2}'", AppSession.ClassSubject.ClassSubjectID, hdnStudentID.Value, hdnGCAttendanceStatus.Value);
            if (isCountPageCount)
            {
