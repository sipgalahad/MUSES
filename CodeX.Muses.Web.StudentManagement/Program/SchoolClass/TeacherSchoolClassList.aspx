<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="TeacherSchoolClassList.aspx.cs" Inherits="CodeX.Muses.Web.StudentManagement.Program.TeacherSchoolClassList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkDetail a').live('click', function () {
            ...
            var url = ResolveUrl('~/Program/SchoolClass/SchoolClassPageLauncher.aspx?id=mtsc|' + tacPeriodSection.getValue() + '|' + id);
