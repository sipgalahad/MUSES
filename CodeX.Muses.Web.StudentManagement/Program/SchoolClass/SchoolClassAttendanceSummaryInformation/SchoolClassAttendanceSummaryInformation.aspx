<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPSchoolClassPageTrx.master" AutoEventWireup="true" 
    CodeBehind="SchoolClassAttendanceSummaryInformation.aspx.cs" Inherits="CodeX.Muses.Web.StudentManagement.Program.SchoolClassAttendanceSummaryInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        $('.lblAttendance.lblLink').live('click', function () {
            ...
            var id = studentID + '|' + GCAttendanceStatus + '|' + cboSubject.GetValue();
            var url = ResolveUrl("~/Program/SchoolClass/SchoolClassAttendanceSummaryInformation/SchoolClassAttendanceSummaryDtCtl.ascx");
