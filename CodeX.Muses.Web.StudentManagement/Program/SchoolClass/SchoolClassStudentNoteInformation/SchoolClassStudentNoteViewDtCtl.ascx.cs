...
{
    public partial class SchoolClassStudentNoteViewDtCtl : BaseViewPopupCtl
    {
        ...
        {
            string filterExpression = string.Format("StudentID = {0} AND SchoolClassID = {1} AND PeriodSectionID = {2} AND IsDeleted = 0", hdnStudentID.Value, AppSession.SchoolClass.SchoolClassID, AppSession.SchoolClass.PeriodSectionID);
            if (hdnNoteCategory.Value != "")
