<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DirectPurchasePRDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.Inventory.Program.DirectPurchasePRDtCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;">
                                <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PurchaseQuantity" HeaderText="Jumlah Pembelian" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="thRight" HeaderStyle-Width="120px" />
                                    </Columns>
                                    <EmptyDataTemplate>
