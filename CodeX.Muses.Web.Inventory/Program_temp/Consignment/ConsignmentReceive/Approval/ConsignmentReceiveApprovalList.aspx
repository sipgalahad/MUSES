...
CodeBehind="ConsignmentReceiveApprovalList.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.ConsignmentReceiveApprovalList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseReceiveHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Consignment/ConsignmentReceive/Approval/ConsignmentReceiveApprovalDetail.aspx?id=' + id);
