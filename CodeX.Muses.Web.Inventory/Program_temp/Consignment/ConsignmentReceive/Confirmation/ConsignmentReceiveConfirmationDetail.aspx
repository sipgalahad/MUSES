<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="ConsignmentReceiveConfirmationDetail.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.ConsignmentReceiveConfirmationDetail" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnPurchaseReceiveBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Consignment/ConsignmentReceive/Confirmation/ConsignmentReceiveConfirmationList.aspx?id=to');
            });
