...
{
    public partial class ConsignmentOrderOutstandingList : BasePageList
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            filterExpression += String.Format("TransactionCode = '{0}' AND GCTransactionStatus = '{1}'", Constant.TransactionCode.CONSIGNMENT_ORDER, Constant.TransactionStatus.APPROVED);
