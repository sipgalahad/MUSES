...
{
    public partial class ConsignmentOrderEntry : BasePageTrx
    {
        ...
        {
            return string.Format("{0};{1};{2};", AppSession.UserLogin.SiteID, AppSession.UserLogin.UserID, Constant.TransactionCode.CONSIGNMENT_ORDER);
        }
        ...
        protected override void InitializeDataControl()
        {
            ...
            List<GetLocationUserList> lstLocation = BusinessLayer.GetLocationUserList(AppSession.UserLogin.SiteID, AppSession.UserLogin.UserID, Constant.TransactionCode.CONSIGNMENT_ORDER, "");
