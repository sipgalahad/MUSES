<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReceiveDtCtl.ascx.cs"
    Inherits="CodeX.Ottimo.Web.Inventory.Program.PurchaseReceiveDtCtl" %>
                            ...
                            <dx:PanelContent ID="PanelContent1" runat="server">
                                <asp:Panel runat="server" ID="pnlView">
                                    <asp:ListView runat="server" ID="lvwView">
                                        <EmptyDataTemplate>
                                            <table id="tblView" runat="server" class="grdView notAllowSelect grdBorder" cellspacing="0" rules="all" >
                                                <tr>
                                                    ...
                                                    <th rowspan="2" class="thCenter" style="width:140px"><%=GetLabel("Harga Satuan")%></th>
                                                    ...
                                                    <th rowspan="2" class="thCenter" style="width:100px"><%=GetLabel("Total")%></th>  
                                                    <th rowspan="2" class="thCenter" style="width:70px"><%=GetLabel("Penerima")%></th>
                                                </tr>
                                                <tr>
                                                    <th style="width:60px" class="thCenter"><%=GetLabel("[%]")%></th>
                                                    <th style="width:100px" class="thCenter"><%=GetLabel("Jumlah")%></th>
