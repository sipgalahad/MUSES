<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReceiveConfirmationEditDtCtl.ascx.cs"
    Inherits="CodeX.Muses.Web.Inventory.Program.PurchaseReceiveConfirmationEditDtCtl" %>
