...
CodeBehind="PurchaseReturnApprovalList.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.PurchaseReturnApprovalList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseReturnHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/WareHouse/PurchaseReturn/Approval/PurchaseReturnApprovalDetail.aspx?id=' + id);
