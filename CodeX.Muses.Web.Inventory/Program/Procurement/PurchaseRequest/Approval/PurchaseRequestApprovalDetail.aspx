<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="PurchaseRequestApprovalDetail.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.PurchaseRequestApprovalDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnPurchaseRequestDetailApprove" crudmode="R" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbapprove.png")%>' alt="" /><br style="clear: both" /><div><%=GetLabel("Approve")%></div></li>
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnPurchaseRequestBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Procurement/PurchaseRequest/Approval/PurchaseRequestApprovalList.aspx?id=to');
            });
                                ...
                                <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdService grdNormal notAllowSelect"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ItemName1" HeaderText="Nama Item" HeaderStyle-Width="300px" />
                                            <asp:BoundField DataField="CustomPurchaseUnit" HeaderText="Di Minta" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Right"/>
                                            <asp:BoundField DataField="BusinessPartnerName" HeaderText="Nama Supplier" HeaderStyle-Width="300px" />
                                            <asp:BoundField DataField="CustomUnitPrice" HeaderText="Harga" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Right"/>
