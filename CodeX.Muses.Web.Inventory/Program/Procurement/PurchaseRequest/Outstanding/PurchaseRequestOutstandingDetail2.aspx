<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="PurchaseRequestOutstandingDetail2.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.PurchaseRequestOutstandingDetail2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        ...
        function onLoad() {
            $('#<%=btnProcessPurchaseRequest.ClientID %>').click(function () {
                ...
                if (locationID == '0' || locationID == '')
                    ...
                    $('#<%=txtLocationCode.ClientID %>').removeClsas('error');
                    var errMessage = { text: '' };
            ...
            $('#lblOrderNo.lblLink').click(function () {
                var id = $('#<%=hdnPurchaseRequestID.ClientID %>').val();
                var url = ResolveUrl("~/Program/Procurement/PurchaseRequest/PurchaseRequestSearchCtl.ascx");
                openUserControlPopup(url, id, 'Permintaan Pembelian', 1000, 600);
            });
            //#endregion
        ...
        $('.lblQuantity.lblLink').live('click', function () {
            ...
            openUserControlPopup(url, id, 'Detil Permintaan Pembelian', 700, 500);
        });
                ...
                <td style="padding: 5px; vertical-align: top">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox ID="txtOrderNo" Width="350px" ReadOnly="true" runat="server" /></td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <table cellpadding="0" cellspacing="0" style="width:100%">
                                                        ...
                                                        <tr>
                                                            <td align="right"><label class="lblQuantity lblLink"><%# Eval("Quantity")%></label></td>
                                                            <td>&nbsp<%# Eval("PurchaseUnit")%></td>
                                                        </tr>
                                                    </table>  
                                                </td>
                                                <td align="left"><%# Eval("CustomConversion")%></td>
                                                <td align="center">
                                                    <table cellpadding="0" cellspacing="0" style="width:100%">
                                                        <colgroup>
                                                            <col />
