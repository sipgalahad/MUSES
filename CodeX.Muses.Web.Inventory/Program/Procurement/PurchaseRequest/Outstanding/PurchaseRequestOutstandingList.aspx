...
CodeBehind="PurchaseRequestOutstandingList.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.PurchaseRequestOutstandingList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseRequestHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Procurement/PurchaseRequest/Outstanding/PurchaseRequestOutstandingDetail.aspx?id=' + id);
