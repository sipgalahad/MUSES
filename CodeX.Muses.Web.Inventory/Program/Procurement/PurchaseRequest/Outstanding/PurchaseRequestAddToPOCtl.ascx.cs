...
namespace CodeX.Muses.Web.Inventory.Program
{
    public partial class PurchaseRequestAddToPOCtl : BaseEntryPopupCtl
    {
        ...
        {
            string filterExpression = String.Format("TransactionCode = '{0}' AND SiteServiceUnitID IN ({1}) AND GCTransactionStatus = '{2}'", Constant.TransactionCode.PURCHASE_ORDER, hdnListSiteServiceUnitID.Value, Constant.TransactionStatus.OPEN);
            if (isCountPageCount)
            {
