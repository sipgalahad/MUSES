<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseBudgetDtCtl.ascx.cs" 
    Inherits="CodeX.Ottimo.Web.Inventory.Program.PurchaseBudgetDtCtl" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <table cellspacing="0">
                                ...
                                <tr>
                                    <td></td>
                                    <td align="center"><h4><%=GetLabel("Anggaran") %></h4></td>
                                    <td align="center"><h4><%=GetLabel("Terpakai") %></h4></td>
                                    <td align="center"><h4><%=GetLabel("Sisa") %></h4></td>
                                </tr>
                                <tr>
                                    <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Qty")%></label></td>
                                    <td><asp:TextBox ID="txtQty" CssClass="number" ReadOnly="true" Width="120px" runat="server" /></td>
                                    <td><asp:TextBox ID="txtQtyUsed" CssClass="number" ReadOnly="true" Width="120px" runat="server" /></td>
                                    <td><asp:TextBox ID="txtQtyRemaining" CssClass="number" ReadOnly="true" Width="120px" runat="server" /></td>
                                </tr>
                                <tr>
                                    <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Nilai")%></label></td>
                                    <td><asp:TextBox ID="txtTotalAmount" CssClass="txtCurrency" ReadOnly="true" Width="120px" runat="server" /></td>
                                    <td><asp:TextBox ID="txtTotalAmountUsed" CssClass="txtCurrency" ReadOnly="true" Width="120px" runat="server" /></td>
                                    <td><asp:TextBox ID="txtTotalAmountRemaining" CssClass="txtCurrency" ReadOnly="true" Width="120px" runat="server" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>  
