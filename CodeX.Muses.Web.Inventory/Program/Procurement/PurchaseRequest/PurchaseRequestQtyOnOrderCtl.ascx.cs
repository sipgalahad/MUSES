...
namespace CodeX.Muses.Web.Inventory.Program
{
    public partial class PurchaseRequestQtyOnOrderCtl : BaseViewPopupCtl
    {
        ...
        {
            string filterExpression = string.Format("FromLocationID = {0} AND ItemID = {1} AND GCTransactionStatus NOT IN ('{2}','{3}') AND IsDeleted = 0", hdnLocationID.Value, hdnItemID.Value, Constant.TransactionStatus.CLOSED, Constant.TransactionStatus.VOID);
