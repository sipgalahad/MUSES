...
{
    public partial class PurchaseOrderApprovalList : BasePageList
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            filterExpression += String.Format("TransactionCode = '{0}' AND GCTransactionStatus = '{1}'", Constant.TransactionCode.PURCHASE_ORDER, Constant.TransactionStatus.WAIT_FOR_APPROVAL);
