<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="PurchaseOrderApprovalDetail.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.PurchaseOrderApprovalDetail" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnPurchaseRequestBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Procurement/PurchaseOrder/Approval/PurchaseOrderApprovalList.aspx');
            });
                                ...
                                <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdService grdNormal notAllowSelect"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CustomPurchaseUnit" ItemStyle-HorizontalAlign="Right" HeaderText="Di Pesan" HeaderStyle-Width="150px" />
