<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrderQtyOnOrderCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.Inventory.Program.PurchaseOrderQtyOnOrderCtl" %>
