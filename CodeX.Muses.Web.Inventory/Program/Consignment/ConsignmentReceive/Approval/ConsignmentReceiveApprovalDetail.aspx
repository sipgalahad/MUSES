<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="ConsignmentReceiveApprovalDetail.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.ConsignmentReceiveApprovalDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnPurchaseReceiveDetailApprove" crudmode="R" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/set.png")%>' alt="" /><br style="clear: both" /><div><%=GetLabel("Approve")%></div></li>
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnPurchaseReceiveBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Consigment/ConsigmentReceive/Approval/ConsigmentReceiveApprovalList.aspx');
            });
