<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="ConsignmentReceiveConfirmationList.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.ConsignmentReceiveConfirmationList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnPurchaseReceiveHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Consignment/ConsignmentReceive/Confirmation/ConsignmentReceiveConfirmationDetail.aspx?id=' + id);
