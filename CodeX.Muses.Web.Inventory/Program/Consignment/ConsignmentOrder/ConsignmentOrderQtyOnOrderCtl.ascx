<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsignmentOrderQtyOnOrderCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.Inventory.Program.ConsignmentOrderQtyOnOrderCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                                <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PurchaseOrderNo" HeaderText="Purchase Order No" HeaderStyle-Width="150px" />
                                        ...
                                        <asp:BoundField DataField="CustomSupplierItem" HeaderText="Supplier Item" HeaderStyle-Width="180px" />
