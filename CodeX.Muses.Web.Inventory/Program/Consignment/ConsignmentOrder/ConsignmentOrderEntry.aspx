<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master"
    AutoEventWireup="true" CodeBehind="ConsignmentOrderEntry.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.ConsignmentOrderEntry" %>
    ...
    <script type="text/javascript">
        ...
        function onLoad() {
            if ($('#<%=hdnIsEditable.ClientID %>').val() == '1') {
                ...
                $('#divTransactionAddFromReceive').show();
            }
            else {
                $('#divTransactionAdd').hide();
                $('#divTransactionAddFromReceive').hide();
            }

            $('#divTransactionAddFromReceive').click(function (evt) {
                if (IsValid(evt, 'fsMPEntry', 'mpEntry')) {
                    ...
                    openUserControlPopup(url, param, 'Penerimaan Tanpa PO', 600, 450);
                }
            });
            ...
            $('#btnQtyOnOrderDetail').click(function () {
                ...
                if (qtyOnOrder != '' && qtyOnOrder != '0') {
                    ...
                    if (itemID != '' && locationID != '') {
                        ...
                        var url = ResolveUrl("~/Program/Consignment/ConsignmentOrder/ConsignmentOrderQtyOnOrderCtl.ascx");
            ...
            <tr>
                <td colspan="2">
                    <div class="divTransactionEntry">
                        ...
                        <span id="divTransactionAddFromReceive" class="divAdd" style="margin-left: 50px;"><%=GetLabel("Tambah Item dari Penerimaan")%></span><br />
