<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="StockAdjustmentEntry.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.StockAdjustmentEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    <script type="text/javascript">
        function onLoad() {
            ...
            $('#<%=txtAdjustmentDate.ClientID %>').datepicker('option', 'maxDate', '0');
            ...
            $('#lblAdjustmentNo.lblLink').click(function () {
            ...
            $('#<%=txtAdjustmentNo.ClientID %>').change(function () {
        ...
        function cboGCAdjustmentTypeChanged() {
            ...
            <tr>
                <td style="padding: 5px; vertical-align: top">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel"><label class="lblLink" id="lblAdjustmentNo"><%=GetLabel("No. Penyesuaian")%></label></td>
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox ID="txtAdjustmentDate" Width="120px" CssClass="datepicker" runat="server" /></td>
                        </tr>
                        <tr>
                            <td class="tdLabel">
                        ...
                        <tr>
                            <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Jenis Penyesuaian")%></label></td>
                            <td>
                                <dxe:ASPxComboBox ID="cboGCAdjustmentType" ClientInstanceName="cboGCAdjustmentType" Width="100%" runat="server" >
                                    <ClientSideEvents ValueChanged="function(s,e){cboGCAdjustmentTypeChanged();}" />
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                    </table>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table style="width: 100%">
                                                ...
                                                <tr>
                                                    <td class="tdLabel">
                                                        <label class="lblMandatory"><%=GetLabel("Alasan Penyesuaian")%></label>
                                                    </td>
                                                    <td>
                                                        <table style="width:100%" cellpadding="0" cellspacing="0">
                                                            <colgroup>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <dxe:ASPxComboBox runat="server" ID="cboGCAdjustmentReason" ClientInstanceName="cboGCAdjustmentReason" Width="100%" />
                                                                </td>
                                                                <td>&nbsp;</td>
                                                                <td>
                                ...
                                <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Quantity" HeaderStyle-CssClass="thRight" HeaderText="Qty Disesuaikan" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
                                            ...
                                            <asp:BoundField DataField="AdjustmentReason" HeaderText="Alasan"/>
