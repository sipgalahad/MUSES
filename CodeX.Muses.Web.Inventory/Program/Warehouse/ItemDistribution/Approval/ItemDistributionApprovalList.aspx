...
CodeBehind="ItemDistributionApprovalList.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.ItemDistributionApprovalList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnItemDistributionHdItem" CRUDMode="R" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/list.png")%>' alt="" /><br style="clear:both"/><div><%=GetLabel("Item")%></div></li>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnItemDistributionHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Warehouse/ItemDistribution/Approval/ItemDistributionApprovalDetail.aspx?id=' + id);
