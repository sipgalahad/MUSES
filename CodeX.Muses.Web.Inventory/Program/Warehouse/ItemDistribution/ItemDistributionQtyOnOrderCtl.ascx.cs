...
{
    public partial class ItemDistributionQtyOnOrderCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            List<vItemDistributionDt> lstEntity = BusinessLayer.GetvItemDistributionDtList(filterExpression, Constant.GridViewPageSize.GRID_POPUP, pageIndex, "DistributionNo DESC");
