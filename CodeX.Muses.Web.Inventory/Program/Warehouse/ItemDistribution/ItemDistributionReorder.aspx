<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master"
    AutoEventWireup="true" CodeBehind="ItemDistributionReorder.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.ItemDistributionReorder" %>
                                ...
                                <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="thCenter" HeaderText="Stok (Dari Lokasi)" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <table cellpadding="0" cellspacing="0" style="width:100%">
                                                        ...
                                                        <tr>
                                                            <td align="right" class="lblReadOnlyText"><div id="divFromLocationQty" runat="server"></div></td>
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="thCenter" HeaderText="Didistribusi" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="thCenter" HeaderText="Total Didistribusi" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <table cellpadding="0" cellspacing="0" style="width:100%">
                                                        <colgroup>
                                                            <col />
