                                ...
                                <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="thCenter" HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                                                <HeaderTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-CssClass="thRight" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Right">
                                                <HeaderTemplate>
                                                    <div>Stok (Dari Lokasi)</div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <div id="divFromLocationQty" runat="server"></div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField HeaderStyle-CssClass="thRight" DataField="CustomMinimum" HeaderText="Minimum" HeaderStyle-Width="120px"
                                                ItemStyle-HorizontalAlign="Right" />
                                            <asp:BoundField HeaderStyle-CssClass="thRight" DataField="CustomMaximum" HeaderText="Maximum" HeaderStyle-Width="120px"
                                                ItemStyle-HorizontalAlign="Right" />
                                            <asp:BoundField HeaderStyle-CssClass="thRight" DataField="CustomEndingBalance" HeaderText="Stok Saat Ini" HeaderStyle-Width="100px"
                                                ItemStyle-HorizontalAlign="Right" />
                                            <asp:TemplateField HeaderStyle-Width="10px" />
                                            <asp:TemplateField ItemStyle-Width="180px" ItemStyle-HorizontalAlign="Left" HeaderText="Didistribusi">
                                                <ItemTemplate>
                                                    <input type="text" id="txtItemRequest" runat="server" validationgroup="mpEntry" class="txtItemRequest number max" value="0" readonly="readonly" style="width:50%" />
                                                    &nbsp;
                                                    <%# Eval("ItemUnit")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Quantity On Order" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="thRight" >
                                                <ItemTemplate>
                                                    ...
                                                    <%#Eval("CustomQtyOnOrderItemDistribution")%> <input type="button" class="btnQtyOnOrderDetail btnMore" value="..."/>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <EmptyDataTemplate>
