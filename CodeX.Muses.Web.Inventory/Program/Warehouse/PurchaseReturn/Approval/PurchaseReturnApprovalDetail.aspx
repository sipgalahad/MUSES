<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="PurchaseReturnApprovalDetail.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.PurchaseReturnApprovalDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnPurchaseReturnDetailApprove" crudmode="R" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbapprove.png")%>' alt="" /><br style="clear: both" /><div><%=GetLabel("Approve")%></div></li>
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnPurchaseReturnListBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/WareHouse/PurchaseReturn/Approval/PurchaseReturnApprovalList.aspx');
            });
