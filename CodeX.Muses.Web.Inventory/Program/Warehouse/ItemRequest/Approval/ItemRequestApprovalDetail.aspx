<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true"
    CodeBehind="ItemRequestApprovalDetail.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.ItemRequestApprovalDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnItemRequestDetailApprove" crudmode="R" runat="server"><img src='<%=ResolveUrl("~/Libs/Images/Icon/tbapprove.png")%>' alt="" /><br style="clear: both" /><div><%=GetLabel("Approve")%></div></li>
    ...
    <script type="text/javascript">
        function onLoad() {
            $('#<%=btnOrderListBack.ClientID %>').click(function () {
                showLoadingPanel();
                document.location = ResolveUrl('~/Program/Warehouse/ItemRequest/Approval/ItemRequestApprovalList.aspx');
            });
