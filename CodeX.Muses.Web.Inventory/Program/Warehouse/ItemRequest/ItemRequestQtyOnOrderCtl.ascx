<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ItemRequestQtyOnOrderCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.Inventory.Program.ItemRequestQtyOnOrderCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                                <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ItemRequestNo" HeaderText="No Permintaan" HeaderStyle-Width="180px" />
                                        <asp:BoundField DataField="FromLocationName" HeaderText="Dari Lokasi" HeaderStyle-Width="180px" />
                                        <asp:BoundField DataField="ToServiceUnitName" HeaderText="Ke Bagian" />
                                        <asp:BoundField DataField="CustomItemRequest" HeaderText="Total Diminta" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="thRight" />
                                    </Columns>
                                    <EmptyDataTemplate>
