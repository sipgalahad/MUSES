<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="PurchaseReceiveRevisionList.aspx.cs" Inherits="CodeX.Ottimo.Web.Inventory.Program.PurchaseReceiveRevisionList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkPurchaseReceive a').live('click', function () {
            $tr = $(this).closest('tr');
            var param = $tr.find('.keyField').html() + '|1';
            var transactionStatus = $tr.find('.hdnGCTransactionStatus').val();
            var url = ResolveUrl("~/Program/Warehouse/PurchaseReceive/Confirmation/PurchaseReceiveConfirmationEditDtCtl.ascx");
            openUserControlPopup(url, param, 'Revisi Penerimaan Pembelian', 1000, 600);
        });
    </script>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="RevisionNo" HeaderText="Revisi" HeaderStyle-CssClass="thRight" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="80px" />
