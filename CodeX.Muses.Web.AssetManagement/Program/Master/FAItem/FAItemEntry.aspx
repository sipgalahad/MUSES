...
CodeBehind="FAItemEntry.aspx.cs" Inherits="Codex.Muses.Web.AssetManagement.Program.FAItemEntry" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            ...
            if ($('#<%=hdnPurchaseReceiveID.ClientID %>').val() != '' && $('#<%=hdnPurchaseReceiveID.ClientID %>').val() != '0') {
                ...
                cboGCProcurementUnit.SetEnabled(false);
    ...
    <table class="tblContentArea">
        ...
        <tr>
            <td style="padding:5px;vertical-align:top">
                <h4><%=GetLabel("Data Aktiva Tetap") %></h4>
                <table class="tblEntryContent" style="width:100%">
                    <colgroup>
                        <col style="width:30%"/>
                    </colgroup>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Kode Aktiva Tetap")%></label></td>
                        <td><asp:TextBox ID="txtFixedAssetCode" Width="180px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Nama Aktiva Tetap")%></label></td>
                        <td><asp:TextBox ID="txtFixedAssetName" Width="100%" runat="server" /></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <table style="width:100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td><asp:TextBox runat="server" ID="txtItemCode" Width="100%" /></td>
                                    <td>&nbsp;</td>
                                    <td><asp:TextBox runat="server" ID="txtItemName" Width="100%" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="tdLabel"><label class="lblLink lblMandatory" id="lblFAGroup"><%=GetLabel("Kelompok Aktiva Tetap")%></label></td>
                        <td>
                            ...
                            <table style="width:100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><asp:TextBox runat="server" ID="txtFAGroupName" Width="100%" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td>
                            ...
                            <table style="width:100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><asp:TextBox runat="server" ID="txtFALocationName" Width="100%" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td><asp:CheckBox ID="chkIsBusinessPartnerFromMaster" runat="server" /><%=GetLabel("Vendor Dari Master")%></td>
                    </tr>
                    <tr id="trBusinessPartnerNonMaster" runat="server">
                        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Vendor")%></label></td>
                        <td><asp:TextBox ID="txtBusinessPartnerNameNonMaster" Width="300px" runat="server" /></td>
                    </tr>
                    <tr id="trBusinessPartner" runat="server">
                        <td class="tdLabel"><label class="lblLink" id="lblBusinessPartner"><%=GetLabel("Vendor")%></label></td>
                        <td>
                            ...
                            <table style="width:100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><asp:TextBox runat="server" ID="txtBusinessPartnerName" Width="100%" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Nomor Kontrak")%></label></td>
                        <td><asp:TextBox ID="txtContractNumber" Width="300px" runat="server" /></td>
                    </tr>
                </table>
            </td>
            <td style="padding:5px;vertical-align:top">
                <h4><%=GetLabel("Data Perolehan Aktiva Tetap") %></h4>
                <table class="tblEntryContent" style="width:100%">
                    <colgroup>
                        <col style="width:30%"/>
                    </colgroup>
                    <tr>
                        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("No. Voucher Perolehan")%></label></td>
                        <td>
                            <input type="hidden" id="hdnPurchaseReceiveID" runat="server" />
                            <asp:TextBox ID="txtProcurementNumber" Width="200px" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Tanggal Perolehan")%></label></td>
                        <td><asp:TextBox ID="txtProcurementDate" CssClass="datepicker" Width="120px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Nilai Perolehan")%></label></td>
                        <td><asp:TextBox ID="txtProcurementAmount" Width="180px" CssClass="txtCurrency" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Quantity Perolehan")%></label></td>
                        <td>
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td><asp:TextBox ID="txtProcurementQuantity" CssClass="number" Width="100%" runat="server" /></td>
                                    <td>&nbsp;</td>
                                    <td><%=GetLabel("Satuan") %></td>
                                    <td>&nbsp;</td>
                                    <td><dxe:ASPxComboBox ID="cboGCProcurementUnit" ClientInstanceName="cboGCProcurementUnit" Width="100%" runat="server" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                </table>
                <h4><%=GetLabel("Data Perhitungan Penyusutan Aktiva Tetap") %></h4>
                <table class="tblEntryContent" style="width:100%">
                    <colgroup>
                        <col style="width:30%"/>
                    </colgroup>
                    ...
                    <tr id="trDepreciationMethod">
                        ...
                        <td>
                            ...
                            <table style="width:100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td><asp:TextBox runat="server" ID="txtFADepreciationMethodCode" Width="100%" /></td>
                                    <td>&nbsp;</td>
                                    <td><asp:TextBox runat="server" ID="txtFADepreciationMethodName" Width="100%" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr id="trDepreciationLength">
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td><asp:TextBox ID="txtDepreciationStartLength" CssClass="number" Width="100%" runat="server" /></td>
                                    <td>&nbsp;</td>
                                    <td><%=GetLabel("Tahun") %></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
        ...
        <tr>
            <td style="padding:0 5px;" colspan="2">
                <h4><%=GetLabel("Pengaturan Perkiraan untuk Aktiva Tetap")%></h4>
            </td>
        </tr>
        <tr>
            <td style="padding:5px;vertical-align:top">
