<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master"
    AutoEventWireup="true" CodeBehind="FAItemList.aspx.cs" Inherits="Codex.Muses.Web.AssetManagement.Program.FAItemList" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="FixedAssetCode" HeaderText="Kode Aktiva" HeaderStyle-Width="180px"
                                    HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="FixedAssetName" HeaderText="Nama Aktiva" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="ItemCode" HeaderText="Kode Item" HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="ItemName1" HeaderText="Nama Item" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Left" />
