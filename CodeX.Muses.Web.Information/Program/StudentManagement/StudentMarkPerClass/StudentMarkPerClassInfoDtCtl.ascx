<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StudentMarkPerClassInfoDtCtl.ascx.cs"
    Inherits="CodeX.Muses.Web.Information.Program.StudentMarkPerClassInfoDtCtl" %>
