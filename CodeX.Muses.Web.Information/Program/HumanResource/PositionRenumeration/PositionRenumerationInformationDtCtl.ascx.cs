...
{
    public partial class PositionRenumerationInformationDtCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            vOrganizationPositionRenumeration entity = BusinessLayer.GetvOrganizationPositionRenumerationList(string.Format(" OrganizationPositionID = {0} AND RenumerationCompID = {1} ", lstParam[0], lstParam[1]))[0];
        ...
        private void BindGridView()
        {
            ...
            List<TransRenumerationCompFormulaDtHour> lstDtHour = BusinessLayer.GetTransRenumerationCompFormulaDtHourList(String.Format(" TransactionDtID = {0} ", hdnID.Value));
            grdView.DataSource = lstDtHour;            
            grdView.DataBind();
        }
