<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PositionRenumerationInformationDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.PositionRenumerationInformationDtCtl" %>
            ...
            <dx:PanelContent ID="PanelContent1" runat="server">
                <asp:Panel runat="server" ID="pnlPatientVisitTransHdGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                    <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty" >
                        <Columns>
                            <asp:BoundField DataField="FromHoursIndex" HeaderText="From Hour" HeaderStyle-Width="120px"/> 
                            <asp:BoundField DataField="ToHoursIndex" HeaderText="To Hour" HeaderStyle-Width="120px"/> 
                            <asp:BoundField DataField="MultiplyBy" HeaderText="Pengali" HeaderStyle-Width="120px"/> 
