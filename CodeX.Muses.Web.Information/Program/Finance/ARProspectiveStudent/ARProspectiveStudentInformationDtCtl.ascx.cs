...
{
    public partial class ARProspectiveStudentInformationDtCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            //string filterExpression = String.Format("MovementDate BETWEEN '{0}' AND '{1}' AND BusinessPartnerID = {2}",lst[0],lst[1],hdnProspectiveStudentID.Value);
            //if (isCountPageCount)
            //{
