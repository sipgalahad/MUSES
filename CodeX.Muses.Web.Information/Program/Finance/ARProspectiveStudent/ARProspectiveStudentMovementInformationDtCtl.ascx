<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ARProspectiveStudentMovementInformationDtCtl.ascx.cs"
    Inherits="CodeX.Muses.Web.Information.Program.ARProspectiveStudentMovementInformationDtCtl" %>
