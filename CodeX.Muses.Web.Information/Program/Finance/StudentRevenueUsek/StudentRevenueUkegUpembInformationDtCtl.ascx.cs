...
namespace CodeX.Muses.Web.Information.Program
{
    public partial class StudentRevenueUkegUpembInformationDtCtl : BaseViewPopupCtl
    {
        ...
        {
            List<vStudentFee> lstEntity = BusinessLayer.GetvStudentFeeList(string.Format("SchoolPeriodID = {0} AND StudentFeeCompTypeID = {1} AND StudentIsDeleted = 0 AND IsDeleted = 0 ORDER BY VirtualAccountNo", hdnSchoolPeriodID.Value, hdnStudentFeeCompTypeID.Value));
