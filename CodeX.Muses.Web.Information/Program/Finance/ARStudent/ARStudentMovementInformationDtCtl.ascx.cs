...
{
    public partial class ARStudentMovementInformationDtCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            string filterExpression = String.Format("MovementDate BETWEEN '{0}' AND '{1}' AND StudentID = {2}", lst[0], lst[1], hdnStudentID.Value);
            if (isCountPageCount)
            {
