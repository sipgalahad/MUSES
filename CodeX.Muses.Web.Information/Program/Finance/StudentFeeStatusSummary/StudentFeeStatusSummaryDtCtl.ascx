<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StudentFeeStatusSummaryDtCtl.ascx.cs"
    Inherits="CodeX.Muses.Web.Information.Program.StudentFeeStatusSummaryDtCtl" %>
                            ...
                            <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="height:330px; overflow-y: scroll;">
                                <asp:GridView ID="grdPopupView" runat="server" CssClass="tblTransactionEntryResult" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="LineAmountWithoutPenalty" HeaderText="Jml" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="thRight" HeaderStyle-Width="100px" DataFormatString="{0:n}" />
                                    </Columns>
                                    <EmptyDataTemplate>
