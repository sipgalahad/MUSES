<%@ Page Language="C#" MasterPageFile="~/MasterPage/MPBaseContent.master" AutoEventWireup="true" 
    CodeBehind="ARCustomerInformation.aspx.cs" Inherits="CodeX.Muses.Web.Information.Program.ARCustomerInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    <script type="text/javascript">
        ...
        $('.lblCustomerName').live('click', function () {
            $tr = $(this).closest('tr');
            var businessPartnerID = $tr.find('.hdnBusinessPartnerID').val();
            var url = ResolveUrl("~/Program/Finance/ARCustomer/ARCustomerMovementInformationDtCtl.ascx");
        ...
        $('.lbl0_30').live('click', function () {
            $tr = $(this).closest('tr');
            var businessPartnerID = $tr.find('.hdnBusinessPartnerID').val();
            var url = ResolveUrl("~/Program/Finance/ARCustomer/ARCustomerInformationDtCtl.ascx");
                                        ...
                                        <asp:ListView runat="server" ID="lvwView">
                                            <EmptyDataTemplate>
                                                <table id="tblView" runat="server" class="grdView notAllowSelect lvwView" cellspacing="0" rules="all" border="1" >
                                                    <tr>
                                                        <th rowspan="2" style="width:120px"><%=GetLabel("Kode")%></th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <label class="lblLink lblCustomerName"><%# Eval("BusinessPartnerName")%></label>
                                                    </td>
