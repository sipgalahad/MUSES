...
{
    public partial class ARCustomerInformationDtCtl : BaseViewPopupCtl
    {
        protected int PageCount = 1;
        protected int CurrPage = 1;

        private ARCustomerInformation DetailPage
        {
            get { return (ARCustomerInformation)Page; }
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<GetARCustomerInformationDt> lstEntity = BusinessLayer.GetARCustomerInformationDtList(DetailPage.GetMovementDate(), Convert.ToInt32(hdnBusinessPartnerID.Value), Convert.ToInt32(hdnDateFrom.Value), Convert.ToInt32(hdnDateTo.Value));
