<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ARCustomerMovementInformationDtCtl.ascx.cs"
    Inherits="CodeX.Muses.Web.Information.Program.ARCustomerMovementInformationDtCtl" %>
