<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPBaseContent.master"
    AutoEventWireup="true" CodeBehind="StudentCoverageInformation.aspx.cs" Inherits="CodeX.Muses.Web.Information.Program.StudentCoverageInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhMPMain" runat="server">
    ...
    <table>
        ...
        <tr>
            <td class="tdLabel"><%=GetLabel("Pemberi Tanggungan") %></td>
            <td>
                <dxe:ASPxComboBox runat="server" ID="cboCustomer" ClientInstanceName="cboCustomer" Width="200px">
                    <ClientSideEvents ValueChanged="function(s,e) { onCboCustomerValueChanged(s); }" />
                </dxe:ASPxComboBox>
            </td>
        </tr>
    </table>
                    ...
                    <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                        ...
                        <div id="divContainerView">
                            <table cellpadding="0" cellspacing="0" class="grdSelected grdBorder tblView">
                                <tr>
                                    <th style="width:150px" rowspan="3"><%=GetLabel("Siswa")%></th>     
                                        ...
                                        <tr>
                                            ...
                                            <asp:Repeater ID="rptViewDt" runat="server">
                                                <ItemTemplate>
                                                    ...
                                                    <td class="thRight"><div><%#Eval("cfCoverageAmount") %></div></td>
