...
{
    public partial class APSupplierInformationDtCtl : BaseViewPopupCtl
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount)
        {
            ...
            List<GetAPSupplierInformationDt> lstEntity = BusinessLayer.GetAPSupplierInformationDtList(DetailPage.GetMovementDate(), Convert.ToInt32(hdnBusinessPartnerID.Value), Convert.ToInt32(hdnDateFrom.Value), Convert.ToInt32(hdnDateTo.Value));
