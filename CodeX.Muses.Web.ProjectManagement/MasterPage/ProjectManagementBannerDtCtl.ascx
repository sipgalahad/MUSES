<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectManagementBannerDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ProjectManagement.MasterPage.ProjectManagementBannerDtCtl" %>
