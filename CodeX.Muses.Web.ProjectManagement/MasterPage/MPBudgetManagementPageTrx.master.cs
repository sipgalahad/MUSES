...
{
    public partial class MPBudgetManagementPageTrx : BaseMP
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string parentCode = Constant.MenuCode.ProjectManagement.BUDGET_MANAGEMENT_PAGE;
                ...
                ((BudgetManagementBannerDtCtl)ctlBanner).InitializeBanner();
                ((MPBaseDetailPageTrx)Master).SetTitleText(((BudgetManagementBannerDtCtl)ctlBanner).OnGetTitleText());
            }
        }
    }
}