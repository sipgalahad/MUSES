<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BudgetManagementBannerDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ProjectManagement.MasterPage.BudgetManagementBannerDtCtl" %>
