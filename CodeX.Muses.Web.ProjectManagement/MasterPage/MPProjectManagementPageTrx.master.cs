...
{
    public partial class MPProjectManagementPageTrx : BaseMP
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string parentCode = Constant.MenuCode.ProjectManagement.PROJECT_MANAGEMENT_PAGE;
                ...
                ((ProjectManagementBannerDtCtl)ctlBanner).InitializeBanner();
                ((MPBaseDetailPageTrx)Master).SetTitleText(((ProjectManagementBannerDtCtl)ctlBanner).OnGetTitleText());
            }
        }
    }
}