<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPEntry.master" AutoEventWireup="true" 
    CodeBehind="OrganizationEntry.aspx.cs" Inherits="CodeX.DTRACK.Web.ProjectManagement.Program.OrganizationEntry" %>
                ...
                <div>
                    <table class="tblEntryContent" style="width:50%">
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox ID="txtTeamCode" Width="100px" runat="server" /></td>
                        </tr>
                        <tr>
                            <td class="tdLabel"><label><%=GetLabel("Nama")%></label></td>
                            <td><asp:TextBox ID="txtTeamName" Width="300px" runat="server" /></td>
                        </tr>
                        <tr>
