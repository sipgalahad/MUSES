<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrganizationDtEntryCtl.ascx.cs" 
    Inherits="CodeX.DTRACK.Web.ProjectManagement.Program.OrganizationDtEntryCtl" %>
...
<script type="text/javascript" id="dxss_serviceunitsiteentryctl">
    ...
    $('#divEntryDtAdd').click(function () {
        ...
        tempHelper.init("Employee" + idxEmployee, "EmployeeCode,EmployeeName", "GetEmployeeList", "", "onGetEmployeeFilterExpression", "EmployeeID");
