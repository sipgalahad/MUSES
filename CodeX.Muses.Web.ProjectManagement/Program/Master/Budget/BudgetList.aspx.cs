...
{
    public partial class BudgetList : BasePageList
    {
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetvProjectBudgetHdRowIndex(filterExpression, keyValue) + 1;
        ...
        {
            url = ResolveUrl("~/Program/Master/Budget/BudgetEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/Budget/BudgetEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
