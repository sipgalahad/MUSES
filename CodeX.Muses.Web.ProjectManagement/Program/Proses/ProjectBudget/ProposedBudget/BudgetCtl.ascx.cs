...
{
    public partial class BudgetCtl : BaseUserControlCtl
    {
        ...
        protected void rptFundItem_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                txtFundItem.CssClass = String.Format("txtCurrency txtBudgetFund txtFund_{0}", e.Item.ItemIndex);
        ...
        private String OnGetFilterExpression()
        {
            ...
            if (hdnID.Value != "")
                filterExpression += String.Format(" AND ProposedBudgetID = {0} AND ItemID IS NULL", hdnID.Value);
            else
        ...
        protected void cbpBudgetView_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            int pageCount = 1;
            int rowCount = 1;
            int OrderID = 0;
