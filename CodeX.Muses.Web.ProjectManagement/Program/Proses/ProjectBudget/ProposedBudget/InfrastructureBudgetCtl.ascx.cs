...
{
    public partial class InfrastructureBudgetCtl : BaseUserControlCtl
    {
        protected int PageCount = 1;
        protected int RowCount = 1;

        //private BasePageTrxCharges DetailPage
        //{
        //    get { return (BasePageTrxCharges)Page; }
        //}

        private ProposedBudgetEntry DetailPage 
        {
            get { return (ProposedBudgetEntry)Page; }
        }

        public void InitializeTransactionControl(vProposedBudgetHd entity)
        {
        ...
        protected void rptFundItem_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                txtFundItem.CssClass = String.Format("txtCurrency txtInfrastructureFund txtFund_{0}", e.Item.ItemIndex);
        ...
        private String OnGetFilterExpression()
        {
            ...
            if (hdnID.Value != "")
                filterExpression += String.Format(" AND ProposedBudgetID = {0} AND ItemID IS NOT NULL", hdnID.Value);
            else
        ...
        protected void grdInfrastructureView_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (grdInfrastructureView.Items.Count > 0)
            {
        ...
        protected void cbpInfrastructureView_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            int pageCount = 1;
            int rowCount = 1;
            int OrderID = 0;
        ...
        public bool OnSaveAddRecordEntityDt(ref string errMessage, ref Int32 OrderID)
        {
            ...
            try
            {
                DetailPage.SaveHeader(ctx, ref OrderID);
