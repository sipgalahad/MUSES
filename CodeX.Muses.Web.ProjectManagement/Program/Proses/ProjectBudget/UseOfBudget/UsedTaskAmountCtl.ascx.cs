...
namespace CodeX.Muses.Web.ProjectManagement.Program
{
    public partial class UsedTaskAmountCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            data = param.Split('|');
            hdnID.Value = data[0];
            vProjectBudgetDt entity = BusinessLayer.GetvProjectBudgetDtList(String.Format("BudgetDtID = {0}", Convert.ToInt32(hdnID.Value)))[0];
            txtProposedBudgetNo.Text = entity.BudgetDtName;
        ...
        {
            String filterExpression = string.Format("BudgetDtID = {0} AND IsDeleted = 0", hdnID.Value);
            return filterExpression;
        }
        ...
        private void BindGridView()
        {
            ...
            if (data[1] == "BI") 
            {
                ...
                vProjectBudgetDt budget = BusinessLayer.GetvProjectBudgetDtList(String.Format("BudgetDtID = {0}", Convert.ToInt32(hdnID.Value)))[0];
