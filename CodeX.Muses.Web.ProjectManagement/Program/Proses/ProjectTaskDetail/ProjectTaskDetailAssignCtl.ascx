<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectTaskDetailAssignCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ProjectManagement.Program.ProjectTaskDetailAssignCtl" %>
