<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="ProjectManagementList.aspx.cs" Inherits="CodeX.Muses.Web.ProjectManagement.Program.ProjectManagementList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lblLink').live('click', function () {
            ...
            var url = ResolveUrl('~/Program/Proses/ProjectManagement/ProjectManagementPageLauncher.aspx?id=' + id);
            openWindowPopup(url, 'Project Management' + id, '1300', '650');
        });
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ProjectCode" HeaderText="Kode" HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Left" />
                                ...
                                <asp:TemplateField HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        ...
                                        <input type="hidden" value="<%#Eval("ProjectID") %>" bindingfield="ProjectID" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
