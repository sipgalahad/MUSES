...
CodeBehind="RBudgetRequestOutstandingList.aspx.cs" Inherits="CodeX.Muses.Web.ProjectManagement.Program.RBudgetRequestOutstandingList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnItemRequestHdItem.ClientID %>').click(function () {
                ...
                var url = ResolveUrl('~/Program/Process/RBudgetRequestOutstanding/RBudgetRequestOutstandingDetail.aspx?id=' + id);
