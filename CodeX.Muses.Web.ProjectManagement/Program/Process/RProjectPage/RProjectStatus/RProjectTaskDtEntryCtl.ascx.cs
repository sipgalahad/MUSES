...
namespace CodeX.Muses.Web.ProjectManagement.Program
{
    public partial class RProjectTaskDtEntryCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            List<StandardCode> lstStandardCode = BusinessLayer.GetStandardCodeList(String.Format("ParentID IN ('{0}','{1}','{2}') AND StandardCodeID NOT IN ('{3}') AND IsActive = 1 AND IsDeleted = 0", Constant.StandardCode.PROJECT_TASK_PRIORITY, Constant.StandardCode.PROJECT_TASK_STATUS, Constant.StandardCode.DUE_DATE_TYPE, Constant.ProjectTaskStatus.VOID));
