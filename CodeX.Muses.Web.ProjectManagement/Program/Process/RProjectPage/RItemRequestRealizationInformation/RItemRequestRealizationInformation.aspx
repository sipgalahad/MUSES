<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPRProjectPageTrx.master" AutoEventWireup="true" 
    CodeBehind="RItemRequestRealizationInformation.aspx.cs" Inherits="CodeX.Muses.Web.ProjectManagement.Program.RItemRequestRealizationInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhEntry" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkDetail a').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/Process/RProjectPage/RItemRequestRealizationInformation/RItemRequestRealizationInformationDtCtl.ascx");
            openUserControlPopup(url, param, 'Detil Realisasi Permintaan Barang', 1200, 600);
        });
    </script>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField DataTextField="ItemRequestNo" HeaderText="No. Permintaan" ItemStyle-CssClass="lnkDetail" HeaderStyle-Width="150px" />
