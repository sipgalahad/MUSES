...
{
    public partial class RItemRequestEntry : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.ProjectManagement.RITEM_REQUEST;
        }
        ...
        {
            string filterExpression = String.Format("TransactionCode = '{0}' AND ProjectID = {1}", hdnTransactionCode.Value, AppSession.ProjectID);
