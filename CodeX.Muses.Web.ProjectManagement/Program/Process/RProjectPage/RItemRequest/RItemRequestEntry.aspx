<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPRProjectPageTrx.master" AutoEventWireup="true" 
    CodeBehind="RItemRequestEntry.aspx.cs" Inherits="CodeX.Muses.Web.ProjectManagement.Program.RItemRequestEntry" %>
        ...
        function onLoad() {
            ...
            $('#divQuickPicks').click(function () {
                if (IsValid(null, 'fsMPEntry', 'mpEntry')) {
                    showLoadingPanel();
                    var url = ResolveUrl('~/Program/Process/RProjectPage/RItemRequest/RItemRequestQuickPicksCtl.ascx');
