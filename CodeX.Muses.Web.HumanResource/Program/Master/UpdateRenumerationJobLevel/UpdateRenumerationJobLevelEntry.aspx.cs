...
{
    public partial class UpdateRenumerationJobLevelEntry : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.HumanResources.UPDATE_RENUMERATION_JOB_LEVEL;
        }
        ...
        public override int OnGetRowCount()
        {
            ...
            return BusinessLayer.GetvTransJobLevelRenumerationHdRowCount(filterExpression);
        }

        protected override void OnLoadEntity(int PageIndex, ref bool isShowWatermark, ref string watermarkText)
        {
            string filterExpression = GetFilterExpression();
            vTransJobLevelRenumerationHd entity = BusinessLayer.GetvTransJobLevelRenumerationHd(filterExpression, PageIndex, "TransactionID DESC");
        ...
        {
            string filterExpression = GetFilterExpression();
            PageIndex = BusinessLayer.GetvTransJobLevelRenumerationHdRowIndex(filterExpression, keyValue, "TransactionID DESC");
            vTransJobLevelRenumerationHd entity = BusinessLayer.GetvTransJobLevelRenumerationHd(filterExpression, PageIndex, "TransactionID DESC");
            EntityToControl(entity, ref isShowWatermark, ref watermarkText);
        }

        private void EntityToControl(vTransJobLevelRenumerationHd entity, ref bool isShowWatermark, ref string watermarkText)
        {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            if (isCountPageCount)
            {
                rowCount = BusinessLayer.GetvTransJobLevelRenumerationDtRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_MASTER);
            }

            List<vTransJobLevelRenumerationDt> lstEntity = BusinessLayer.GetvTransJobLevelRenumerationDtList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex, "JobLevelName ASC");
        ...
        #region Save Header
        public void SaveTransJobLevelRenumerationHd(IDbContext ctx, ref int TransactionID)
        {
            TransJobLevelRenumerationHdDao entityHdDao = new TransJobLevelRenumerationHdDao(ctx);
            if (hdnTransactionID.Value == "0")
            {
                ...
                TransactionID = BusinessLayer.GetTransJobLevelRenumerationHdMaxID(ctx);
            }
            else
            {
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            {
                int OrderID = 0;
                SaveTransJobLevelRenumerationHd(ctx, ref OrderID);
        ...
        protected override bool OnApproveRecord(ref string errMessage)
        {
            bool result = true;
            IDbContext ctx = DbFactory.Configure(true);
            TransJobLevelRenumerationHdDao transJobLevelRenumerationHdDao = new TransJobLevelRenumerationHdDao(ctx);
            JobLevelDao jobLevelDao = new JobLevelDao(ctx);
            try
            {
                TransJobLevelRenumerationHd transJobLevelRenumerationHd = transJobLevelRenumerationHdDao.Get(Convert.ToInt32(hdnTransactionID.Value));
                transJobLevelRenumerationHd.GCTransactionStatus = Constant.TransactionStatus.APPROVED;
                transJobLevelRenumerationHd.Remarks = txtRemarks.Text;
                transJobLevelRenumerationHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                transJobLevelRenumerationHdDao.Update(transJobLevelRenumerationHd);

                if (String.Compare(transJobLevelRenumerationHd.StartEffectiveDate.ToString("yyyyMMdd"), DateTime.Now.ToString("yyyyMMdd")) <= 0)
                {
                    List<JobLevel> lstJobLevel = BusinessLayer.GetJobLevelList(String.Format("JobLevelID IN (SELECT JobLevelID FROM TransJobLevelRenumerationDt WHERE TransactionID = {0})", hdnTransactionID.Value), ctx);
                    foreach (JobLevel jobLevel in lstJobLevel)
                    {
        ...
        protected override bool OnProposeRecord(ref string errMessage)
        {
            ...
            {
                TransJobLevelRenumerationHd transJobLevelRenumerationHd = transJobLevelRenumerationHdDao.Get(Convert.ToInt32(hdnTransactionID.Value));
                transJobLevelRenumerationHd.GCTransactionStatus = Constant.TransactionStatus.WAIT_FOR_APPROVAL;
                transJobLevelRenumerationHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                transJobLevelRenumerationHdDao.Update(transJobLevelRenumerationHd);
        ...
        protected override bool OnReopenRecord(ref string errMessage)
        {
            ...
            try
            {
                ...
                {
                    transJobLevelRenumerationHd.GCTransactionStatus = Constant.TransactionStatus.OPEN;
                    transJobLevelRenumerationHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                    transJobLevelRenumerationHdDao.Update(transJobLevelRenumerationHd);
                }
        ...
        protected override bool OnVoidRecord(ref string errMessage)
        {
            ...
            {
                TransJobLevelRenumerationHd transJobLevelRenumerationHd = transJobLevelRenumerationHdDao.Get(Convert.ToInt32(hdnTransactionID.Value));
                transJobLevelRenumerationHd.GCTransactionStatus = Constant.TransactionStatus.VOID;
                transJobLevelRenumerationHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                transJobLevelRenumerationHdDao.Update(transJobLevelRenumerationHd);
        ...
        private void ControlToEntity(TransJobLevelRenumerationDt entityDt)
        {
            entityDt.JobLevelID = Convert.ToInt32(tacJobLevelID.Value);
        }
        ...
        private bool OnSaveAddRecordEntityDt(ref string errMessage, ref int TransactionID)
        {
            bool result = true;
            IDbContext ctx = DbFactory.Configure(true);
            TransJobLevelRenumerationDtDao entityDtDao = new TransJobLevelRenumerationDtDao(ctx);
            try
            {
                SaveTransJobLevelRenumerationHd(ctx, ref TransactionID);
                TransJobLevelRenumerationDt entityDt = new TransJobLevelRenumerationDt();
        ...
        private bool OnDeleteEntityDt(ref string errMessage, int ID)
        {
            try
            {
                BusinessLayer.DeleteTransJobLevelRenumerationDt(Convert.ToInt32(hdnTransactionID.Value), Convert.ToInt32(hdnEntryID.Value));
                return true;
            }
            catch (Exception ex)
            {
