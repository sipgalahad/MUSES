<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="UpdateEmployeeRenumerationEntry.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.UpdateEmployeeRenumerationEntry" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            ...
            $('#btnRenumerationID').click(function () {
                var PositionID = cboRenumerationID.GetValue();
        ...
        function oncboRenumerationIDValueChanged() {
            getCurrentTransRenumerationID();
        }

        function getCurrentTransRenumerationID() {
            if (cboRenumerationID.GetValue() != null) {
                var filterExpression = "StartEffectiveDate <= '" + Methods.dateToYMD(Methods.getDatePickerDate($('#<%=txtStartEffectiveDate.ClientID %>').val())) + "' AND OrganizationPositionID = " + cboRenumerationID.GetValue() + " AND GCTransactionStatus = '<%=OnGetTransactionStatusApproved() %>' ORDER BY StartEffectiveDate DESC";
            ...
            <tr>
                <td style="padding: 5px; vertical-align: top">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Renumerasi")%></label></td>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <dxe:ASPxComboBox ID="cboRenumerationID" ClientInstanceName="cboRenumerationID" Width="200px" runat="server">
                                                <ClientSideEvents ValueChanged="function(s,e) { oncboRenumerationIDValueChanged() }" />
                                            </dxe:ASPxComboBox>
                                        </td>
                                        ...
                                        <tr>
                                            <td valign="top">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><asp:TextBox ID="txtAmount" CssClass="txtCurrency" Width="120px" runat="server" readonly="false"/></td>
                                                </tr>
                                                <tr>
                                                    <td class="tdLabel"></td>
