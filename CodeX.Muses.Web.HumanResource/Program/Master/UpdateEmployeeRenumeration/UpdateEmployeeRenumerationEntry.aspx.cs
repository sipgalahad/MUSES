...
{
    public partial class UpdateEmployeeRenumerationEntry : BasePageTrx
    {
        ...
        {
            List<vRenumerationHd> listRenumerationHd = BusinessLayer.GetvRenumerationHdList(string.Format("IsDeleted = 0 AND GCRenumerationCompSource = '{0}' ", Constant.RenumerationCompSource.EMPLOYEE));
            Methods.SetComboBoxField<vRenumerationHd>(cboRenumerationID, listRenumerationHd, "RenumerationName", "RenumrationID");
        }
        ...
        public override int OnGetRowCount()
        {
            ...
            return BusinessLayer.GetvTransEmployeeRenumerationHdRowCount(filterExpression);
        }

        protected override void OnLoadEntity(int PageIndex, ref bool isShowWatermark, ref string watermarkText)
        {
            string filterExpression = GetFilterExpression();
            vTransEmployeeRenumerationHd entity = BusinessLayer.GetvTransEmployeeRenumerationHd(filterExpression, PageIndex, "TransactionID DESC");
        ...
        {
            string filterExpression = GetFilterExpression();
            PageIndex = BusinessLayer.GetvTransEmployeeRenumerationHdRowIndex(filterExpression, keyValue, "TransactionID DESC");
            vTransEmployeeRenumerationHd entity = BusinessLayer.GetvTransEmployeeRenumerationHd(filterExpression, PageIndex, "TransactionID DESC");
            EntityToControl(entity, ref isShowWatermark, ref watermarkText);
        }

        private void EntityToControl(vTransEmployeeRenumerationHd entity, ref bool isShowWatermark, ref string watermarkText)
        {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            if (isCountPageCount)
            {
                rowCount = BusinessLayer.GetvTransEmployeeRenumerationDtRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_MASTER);
            }

            List<vTransEmployeeRenumerationDt> lstEntity = BusinessLayer.GetvTransEmployeeRenumerationDtList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex, "EmployeeName ASC");
        ...
        #region Save Header
        public void SaveTransEmployeeRenumerationHd(IDbContext ctx, ref int TransactionID)
        {
            TransEmployeeRenumerationHdDao entityHdDao = new TransEmployeeRenumerationHdDao(ctx);
            if (hdnTransactionID.Value == "0")
            {
                TransEmployeeRenumerationHd entityHd = new TransEmployeeRenumerationHd();
                ...
                entityHd.TransactionNo = BusinessLayer.GenerateTransactionNo(Constant.TransactionCode.JOB_LEVEL_POSITION_RENUMERATION, entityHd.TransactionDate, ctx);
                ...
                TransactionID = BusinessLayer.GetTransEmployeeRenumerationHdMaxID(ctx);
            }
            else
            {
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            {
                int OrderID = 0;
                SaveTransEmployeeRenumerationHd(ctx, ref OrderID);
        ...
        protected override bool OnSaveEditRecord(ref string errMessage, ref string retval)
        {
            try
            {
                TransEmployeeRenumerationHd entityHd = BusinessLayer.GetTransEmployeeRenumerationHd(Convert.ToInt32(hdnTransactionID.Value));
                entityHd.TransactionDate = Helper.GetDatePickerValue(Request.Form[txtTransactionDate.UniqueID]);
                entityHd.StartEffectiveDate = Helper.GetDatePickerValue(Request.Form[txtStartEffectiveDate.UniqueID]);
                entityHd.RenumerationID = Convert.ToInt32(cboRenumerationID.Value);
                entityHd.Remarks = txtRemarks.Text;
                entityHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.UpdateTransEmployeeRenumerationHd(entityHd);
                return true;
            }
            catch (Exception ex)
            {
        ...
        protected override bool OnApproveRecord(ref string errMessage)
        {
            bool result = true;
            IDbContext ctx = DbFactory.Configure(true);
            TransEmployeeRenumerationHdDao transEmployeeRenumerationHdDao = new TransEmployeeRenumerationHdDao(ctx);
            EmployeeDao employeeDao = new EmployeeDao(ctx);
            try
            {
                TransEmployeeRenumerationHd transEmployeeRenumerationHd = transEmployeeRenumerationHdDao.Get(Convert.ToInt32(hdnTransactionID.Value));
                transEmployeeRenumerationHd.GCTransactionStatus = Constant.TransactionStatus.APPROVED;
                transEmployeeRenumerationHd.Remarks = txtRemarks.Text;
                transEmployeeRenumerationHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                transEmployeeRenumerationHdDao.Update(transEmployeeRenumerationHd);

                if (String.Compare(transEmployeeRenumerationHd.StartEffectiveDate.ToString("yyyyMMdd"), DateTime.Now.ToString("yyyyMMdd")) <= 0)
                {
                    List<Employee> lstEmpl = BusinessLayer.GetEmployeeList(String.Format("EmployeeID IN (SELECT EmployeeID FROM TransEmployeeRenumerationDt WHERE TransactionID = {0})", hdnTransactionID.Value), ctx);
                    foreach (Employee employee in lstEmpl)
                    {
                        employee.CurrentTransRenumerationID = Convert.ToInt32(hdnTransactionID.Value);
                        employee.LastProcessedRenumerationDate = DateTime.Now;
        ...
        protected override bool OnProposeRecord(ref string errMessage)
        {
            ...
            {
                TransEmployeeRenumerationHd transEmployeeRenumerationHd = transEmployeeRenumerationHdDao.Get(Convert.ToInt32(hdnTransactionID.Value));
                transEmployeeRenumerationHd.GCTransactionStatus = Constant.TransactionStatus.WAIT_FOR_APPROVAL;
                transEmployeeRenumerationHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                transEmployeeRenumerationHdDao.Update(transEmployeeRenumerationHd);
        ...
        protected override bool OnReopenRecord(ref string errMessage)
        {
            ...
            try
            {
                ...
                {
                    transEmployeeRenumerationHd.GCTransactionStatus = Constant.TransactionStatus.OPEN;
                    transEmployeeRenumerationHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                    transEmployeeRenumerationHdDao.Update(transEmployeeRenumerationHd);
                }
                ctx.CommitTransaction();
        ...
        protected override bool OnVoidRecord(ref string errMessage)
        {
            ...
            {
                TransEmployeeRenumerationHd transEmployeeRenumerationHd = transEmployeeRenumerationHdDao.Get(Convert.ToInt32(hdnTransactionID.Value));
                transEmployeeRenumerationHd.GCTransactionStatus = Constant.TransactionStatus.VOID;
                transEmployeeRenumerationHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                transEmployeeRenumerationHdDao.Update(transEmployeeRenumerationHd);
        ...
        private void ControlToEntity(TransEmployeeRenumerationDt entityDt)
        {
        ...
        private bool OnSaveAddRecordEntityDt(ref string errMessage, ref int TransactionID)
        {
            bool result = true;
            IDbContext ctx = DbFactory.Configure(true);
            TransEmployeeRenumerationDtDao entityDtDao = new TransEmployeeRenumerationDtDao(ctx);
            try
            {
                SaveTransEmployeeRenumerationHd(ctx, ref TransactionID);
                TransEmployeeRenumerationDt entityDt = new TransEmployeeRenumerationDt();
        ...
        private bool OnDeleteEntityDt(ref string errMessage, int ID)
        {
            try
            {
                BusinessLayer.DeleteTransEmployeeRenumerationDt(Convert.ToInt32(hdnTransactionID.Value), Convert.ToInt32(tacEmployeeID.Value));
                return true;
            }
            catch (Exception ex)
            {
