<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateEmployeePositionEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.UpdateEmployeePositionEntryCtl" %>
