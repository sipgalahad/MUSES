...
{
    public partial class UpdateEmployeePositionEntryCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            vTransEmployeePositionRenumeration entity = BusinessLayer.GetvTransEmployeePositionRenumerationList(string.Format("TransactionDtID = {0}", hdnID.Value))[0];
        ...
        private bool OnSaveRecordEntityDt(ref string errMessage)
        {
            try
            {
                TransEmployeePositionRenumerationFormula entity = BusinessLayer.GetTransEmployeePositionRenumerationFormula(Convert.ToInt32(hdnID.Value), hdnGCDayType.Value);
                if (entity == null)
                {
                    //ControlToEntity(entity);
                    //entity.OrganizationDepartmentID = Convert.ToInt32(hdnID.Value);
                    //entity.CreatedBy = AppSession.UserLogin.UserID;
                    entity = new TransEmployeePositionRenumerationFormula();
                    ...
                    BusinessLayer.InsertTransEmployeePositionRenumerationFormula(entity);
                }
                else
                {
                    entity.FormulaID = Convert.ToInt32(hdnFormulaID.Value);
                    BusinessLayer.UpdateTransEmployeePositionRenumerationFormula(entity);
        ...
        private bool OnDeleteEntityDt(ref string errMessage)
        {
            try
            {
                ...
                BusinessLayer.DeleteTransEmployeePositionRenumerationFormula(Convert.ToInt32(hdnID.Value), hdnGCDayType.Value);
                return true;
            }
            catch (Exception ex)
            {
