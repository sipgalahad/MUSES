<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="UpdateEmployeeJobLevelEntry2.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.UpdateEmployeeJobLevelEntry2" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            ...
            $('#btnRenumerationID').click(function () {
                var JobLevelID = cboJobLevelID.GetValue();
                if (JobLevelID != null && JobLevelID != '') {
                    var id = "ej|" + $('#<%=hdnTransRenumerationID.ClientID %>').val() + "|" + JobLevelID;
            ...
            $('.lnkDetail a').live('click', function () {
                ...
                //alert(id);
                var url = ResolveUrl("~/Program/Master/UpdateEmployeeJobLevel/UpdateEmployeeJobLevelEntryCtl.ascx");
        ...
        function oncboJobLevelIDValueChanged() {
            getCurrentTransRenumerationID();
        }
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <dxe:ASPxComboBox ID="cboJobLevelID" ClientInstanceName="cboJobLevelID" Width="200px" runat="server">
                                                <ClientSideEvents ValueChanged="function(s,e) { oncboJobLevelIDValueChanged() }" />
                                            </dxe:ASPxComboBox>
                                        </td>
