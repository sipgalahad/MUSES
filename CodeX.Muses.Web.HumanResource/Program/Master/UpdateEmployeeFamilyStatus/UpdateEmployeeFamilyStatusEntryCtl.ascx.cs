...
{
    public partial class UpdateEmployeeFamilyStatusEntryCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            vTransEmployeeFamilyStatusRenumeration entity = BusinessLayer.GetvTransEmployeeFamilyStatusRenumerationList(string.Format("TransactionDtID = {0}", hdnID.Value))[0];
        ...
        private void BindGridView()
        {
            ...
            lstEntity = BusinessLayer.GetvTransEmployeeFamilyStatusRenumerationFormulaList(string.Format("TransactionDtID = {0}", hdnID.Value));
            grdView.DataSource = lstDayType;            
            grdView.DataBind();
        }

        List<vTransEmployeeFamilyStatusRenumerationFormula> lstEntity = null;
        protected void grdView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                vTransEmployeeFamilyStatusRenumerationFormula entityFormula = lstEntity.FirstOrDefault(p => p.GCDayType == entity.StandardCodeID);
        ...
        private void ControlToEntity(TransEmployeePositionRenumerationFormula entity)
        {
        ...
        private bool OnSaveRecordEntityDt(ref string errMessage)
        {
            try
            {
                TransEmployeeFamilyStatusRenumerationFormula entity = BusinessLayer.GetTransEmployeeFamilyStatusRenumerationFormula(Convert.ToInt32(hdnID.Value), hdnGCDayType.Value);
                if (entity == null)
                {
                    //ControlToEntity(entity);
                    //entity.OrganizationDepartmentID = Convert.ToInt32(hdnID.Value);
                    //entity.CreatedBy = AppSession.UserLogin.UserID;
                    entity = new TransEmployeeFamilyStatusRenumerationFormula();
                    ...
                    BusinessLayer.InsertTransEmployeeFamilyStatusRenumerationFormula(entity);
                }
                else
                {
                    entity.FormulaID = Convert.ToInt32(hdnFormulaID.Value);
                    BusinessLayer.UpdateTransEmployeeFamilyStatusRenumerationFormula(entity);
        ...
        private bool OnDeleteEntityDt(ref string errMessage)
        {
            try
            {
                ...
                BusinessLayer.DeleteTransEmployeeFamilyStatusRenumerationFormula(Convert.ToInt32(hdnID.Value), hdnGCDayType.Value);
                return true;
            }
            catch (Exception ex)
            {
