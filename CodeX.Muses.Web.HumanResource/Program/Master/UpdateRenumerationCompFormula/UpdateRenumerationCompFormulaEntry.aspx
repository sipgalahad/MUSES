<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="UpdateRenumerationCompFormulaEntry.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.UpdateRenumerationCompFormulaEntry" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            ...
            $('#lblTransactionNo.lblLink').click(function () {
                openSearchDialog('transrenumerationcompformulahd', onGetRenumerationPositionFilterExpression(), function (value) {
