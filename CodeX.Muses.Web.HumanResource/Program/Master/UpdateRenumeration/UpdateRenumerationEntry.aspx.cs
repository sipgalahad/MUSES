...
namespace CodeX.Muses.Web.Inventory.Program
{
    public partial class UpdateRenumerationEntry : BasePageTrx
    {
        ...
        protected override void InitializeDataControl()
        {
            ...
            Helper.SetControlEntrySetting(chkIsAllowChange, new ControlEntrySetting(true, true, true), "mpTrx");
            Helper.SetControlEntrySetting(chkIsUseFormula, new ControlEntrySetting(true, true, true), "mpTrx");
        }
