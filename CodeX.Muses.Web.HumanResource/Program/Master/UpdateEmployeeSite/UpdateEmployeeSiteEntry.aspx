    ...
    <script type="text/javascript">
        ...
        function onAfterSaveRecordDtSuccess(TransactionID) {
            if ($('#<%=hdnTransactionID.ClientID %>').val() == '0') {
                ...
                Methods.getObject('GetvTransEmployeeSiteHdList', filterExpression, function (result) {
                ...
                <td style="padding: 5px; vertical-align: top">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td><dxe:ASPxComboBox ID="cboSiteID" ClientInstanceName="cboSiteID" Width="200px" runat="server" /></td>
                        </tr>
                       <tr>
