<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="UpdateEmployeeSiteEntry.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.UpdateEmployeeSiteEntry" %>
    ...
    <script type="text/javascript">
        function onLoad() {
            ...
            $('#btnRenumerationID').click(function () {
                var PositionID = cboSiteID.GetValue();
        ...
        function oncboSiteIDValueChanged() {
            getCurrentTransRenumerationID();
        }

        function getCurrentTransRenumerationID() {
            if (cboSiteID.GetValue() != null) {
                var filterExpression = "StartEffectiveDate <= '" + Methods.dateToYMD(Methods.getDatePickerDate($('#<%=txtStartEffectiveDate.ClientID %>').val())) + "' AND OrganizationPositionID = " + cboSiteID.GetValue() + " AND GCTransactionStatus = '<%=OnGetTransactionStatusApproved() %>' ORDER BY StartEffectiveDate DESC";
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <dxe:ASPxComboBox ID="cboSiteID" ClientInstanceName="cboSiteID" Width="200px" runat="server">
                                                <ClientSideEvents ValueChanged="function(s,e) { oncboSiteIDValueChanged() }" />
                                            </dxe:ASPxComboBox>
                                        </td>
