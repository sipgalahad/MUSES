<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPTrx.master" AutoEventWireup="true" 
    CodeBehind="AbsenceProposalEntry.aspx.cs" Inherits="CodeX.Muses.Web.Inventory.Program.AbsenceProposalEntry" %>
...
//            });
        ...
        $('#<%=grdView2.ClientID %> .divDetailEdit').live('click', function () {
            ...
            setDatePicker('<%=txtEndDate.ClientID %>');
            $('#<%=chkIsFullDay.ClientID %>').prop('checked', entity.IsFullDay == 'True');
        ...
        function onGetEmployeeFilterExpression() {
            var TransactionID = $('#<%=hdnTransactionID.ClientID %>').val();
            var filterExpression = "IsDeleted = 0 AND EmployeeID NOT IN (SELECT EmployeeID FROM HRScheduleGroupEmployee where TransactionID = " + TransactionID + ")";
            return filterExpression;
        }
            ...
            <tr>
                <td style="padding: 5px; vertical-align: top">
                    <table class="tblEntryContent" style="width: 100%">
                        ...
                        <tr>
                            <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Absen")%></label></td>
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td><dxe:ASPxComboBox ID="cboGCAttendanceStatus" ClientInstanceName="cboGCAttendanceStatus" Width="200px" runat="server" /></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td><dxe:ASPxComboBox ID="cboGCAbsenceReason" ClientInstanceName="cboGCAbsenceReason" Width="200px" runat="server" /></td>
                                        <td style="width:5px;"></td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <asp:Panel runat="server" ID="pnlView2" Style="width: 100%; margin-left: auto; margin-right: auto;
                                        ...
                                        <asp:GridView ID="grdView2" runat="server" CssClass="tblTransactionEntryResult"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="StartDateInDatePickerFormat" HeaderText="Tanggal Mulai" />
                                                <asp:BoundField DataField="EndDateInDatePickerFormat" HeaderText="Tanggal Berakhir" />
                                                <asp:CheckBoxField DataField="IsFullDay" HeaderText="Full Day" HeaderStyle-CssClass="thCenter" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="200px"/>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        ...
                                                        <input type="hidden" value="<%#Eval("IsFullDay") %>" bindingfield="IsFullDay" />
