...
{
    public partial class TransEmployeeLoanEntry : BasePageTrx
    {
        ...
        {
            return Constant.MenuCode.HumanResources.EMPLOYEE_LOAN;
        }
        ...
        protected override void OnControlEntrySetting()
        {
            ...
            SetControlEntrySetting(txtStartPaymentDate, new ControlEntrySetting(true, true, false, Constant.DefaultValueEntry.DATE_NOW));
            //SetControlEntrySetting(cboFormulaID, new ControlEntrySetting(true, true, true));
            SetControlEntrySetting(tacEmployeeID, new ControlEntrySetting(true, true, true, ""));
            SetControlEntrySetting(tacRenumerationCompID, new ControlEntrySetting(true, true, true, ""));
            SetControlEntrySetting(txtTransactionAmount, new ControlEntrySetting(true, true, true, "0"));
            SetControlEntrySetting(txtInterestPercentage, new ControlEntrySetting(true, true, true, "0"));
            SetControlEntrySetting(txtTotalAmount, new ControlEntrySetting(true, true, true, "0"));
            SetControlEntrySetting(txtNoOfPayment, new ControlEntrySetting(true, true, true, ""));
        ...
        public override int OnGetRowCount()
        {
            ...
            return BusinessLayer.GetvTransEmployeeLoanHdRowCount(filterExpression);
        }

        protected override void OnLoadEntity(int PageIndex, ref bool isShowWatermark, ref string watermarkText)
        {
            string filterExpression = GetFilterExpression();
            vTransEmployeeLoanHd entity = BusinessLayer.GetvTransEmployeeLoanHd(filterExpression, PageIndex, "TransactionID DESC");
        ...
        {
            string filterExpression = GetFilterExpression();
            PageIndex = BusinessLayer.GetvTransEmployeeLoanHdRowIndex(filterExpression, keyValue, "TransactionID DESC");
            vTransEmployeeLoanHd entity = BusinessLayer.GetvTransEmployeeLoanHd(filterExpression, PageIndex, "TransactionID DESC");
            EntityToControl(entity, ref isShowWatermark, ref watermarkText);
        }

        private void EntityToControl(vTransEmployeeLoanHd entity, ref bool isShowWatermark, ref string watermarkText)
        {
            ...
            txtStartPaymentDate.Text = entity.StartPaymentDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
            txtTransactionDate.Text = entity.TransactionDate.ToString(Constant.FormatString.DATE_PICKER_FORMAT);
            tacEmployeeID.Value = entity.EmployeeID.ToString();
            tacEmployeeID.Text = entity.EmployeeName.ToString();
            tacRenumerationCompID.Value = entity.RenumerationCompID.ToString();
            tacRenumerationCompID.Text = entity.RenumerationCompName.ToString();
            txtNoOfPayment.Text = entity.NoOfPayment.ToString();
            txtTransactionAmount.Text = entity.TransactionAmount.ToString();
            txtTotalAmount.Text = entity.TotalAmount.ToString();
            txtInterestPercentage.Text = entity.InterestPercentage.ToString();
        ...
        #region Save Header
        public void SaveTransEmployeeLoanHd(IDbContext ctx, ref int TransactionID)
        {
            TransEmployeeLoanHdDao entityHdDao = new TransEmployeeLoanHdDao(ctx);
            if (hdnTransactionID.Value == "0")
            {
                TransEmployeeLoanHd entityHd = new TransEmployeeLoanHd();
                entityHd.TransactionDate = Helper.GetDatePickerValue(Request.Form[txtTransactionDate.UniqueID]);
                entityHd.StartPaymentDate = Helper.GetDatePickerValue(Request.Form[txtStartPaymentDate.UniqueID]);
                //entityHd.FormulaID = Convert.ToInt32(cboFormulaID.Value);
                entityHd.Remarks = txtRemarks.Text;
                entityHd.TransactionNo = BusinessLayer.GenerateTransactionNo(Constant.TransactionCode.EMPLOYEE_LOAN, entityHd.TransactionDate, ctx);
                entityHd.GCTransactionStatus = Constant.TransactionStatus.OPEN;

                entityHd.EmployeeID = Convert.ToInt32(tacEmployeeID.Value);
                entityHd.RenumerationCompID = Convert.ToInt32(tacRenumerationCompID.Value);
                entityHd.NoOfPayment = Convert.ToInt16(txtNoOfPayment.Text);
                entityHd.TransactionAmount = Convert.ToDecimal(txtTransactionAmount.Text);
                entityHd.TotalAmount = Convert.ToDecimal(txtTotalAmount.Text);
                entityHd.InterestPercentage = Convert.ToDecimal(txtInterestPercentage.Text);

                ctx.CommandType = CommandType.Text;
                ctx.Command.Parameters.Clear();
                entityHd.CreatedBy = AppSession.UserLogin.UserID;
                entityHdDao.Insert(entityHd);
                TransactionID = BusinessLayer.GetTransEmployeeLoanHdMaxID(ctx);
            }
            else
            {
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            {
                int OrderID = 0;
                SaveTransEmployeeLoanHd(ctx, ref OrderID);
        ...
        protected override bool OnSaveEditRecord(ref string errMessage, ref string retval)
        {
            try
            {
                TransEmployeeLoanHd entityHd = BusinessLayer.GetTransEmployeeLoanHd(Convert.ToInt32(hdnTransactionID.Value));
                entityHd.TransactionDate = Helper.GetDatePickerValue(Request.Form[txtTransactionDate.UniqueID]);
                entityHd.StartPaymentDate = Helper.GetDatePickerValue(Request.Form[txtStartPaymentDate.UniqueID]);
                entityHd.EmployeeID = Convert.ToInt32(tacEmployeeID.Value);
                entityHd.RenumerationCompID = Convert.ToInt32(tacRenumerationCompID.Value);
                ...
                BusinessLayer.UpdateTransEmployeeLoanHd(entityHd);
                return true;
            }
            catch (Exception ex)
            {
        ...
        protected override bool OnApproveRecord(ref string errMessage)
        {
            bool result = true;
            IDbContext ctx = DbFactory.Configure(true);
            TransEmployeeLoanHdDao TransEmployeeLoanHdDao = new TransEmployeeLoanHdDao(ctx);
            ...
            try
            {
                TransEmployeeLoanHd TransEmployeeLoanHd = TransEmployeeLoanHdDao.Get(Convert.ToInt32(hdnTransactionID.Value));
                TransEmployeeLoanHd.GCTransactionStatus = Constant.TransactionStatus.APPROVED;
                TransEmployeeLoanHd.Remarks = txtRemarks.Text;
                TransEmployeeLoanHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                TransEmployeeLoanHdDao.Update(TransEmployeeLoanHd);
        ...
        protected override bool OnProposeRecord(ref string errMessage)
        {
            ...
            {
                TransEmployeeLoanHd transEmployeeLoanHd = transEmployeeLoanHdDao.Get(Convert.ToInt32(hdnTransactionID.Value));
                transEmployeeLoanHd.GCTransactionStatus = Constant.TransactionStatus.WAIT_FOR_APPROVAL;
                transEmployeeLoanHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                transEmployeeLoanHdDao.Update(transEmployeeLoanHd);
        ...
        protected override bool OnReopenRecord(ref string errMessage)
        {
            bool result = true;
            IDbContext ctx = DbFactory.Configure(true);
            TransEmployeeLoanHdDao transRenumerationCompFormulaHdDao = new TransEmployeeLoanHdDao(ctx);
            //TransRenumerationCompFormulaDtDao transRenumerationCompFormulaDtDao = new TransRenumerationCompFormulaDtDao(ctx);
            
            try
            {
                TransEmployeeLoanHd transEmployeeLoanHd = transRenumerationCompFormulaHdDao.Get(Convert.ToInt32(hdnTransactionID.Value));
                transEmployeeLoanHd.GCTransactionStatus = Constant.TransactionStatus.OPEN;
                transEmployeeLoanHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                transRenumerationCompFormulaHdDao.Update(transEmployeeLoanHd);
        ...
        protected override bool OnVoidRecord(ref string errMessage)
        {
            ...
            {
                TransEmployeeLoanHd transEmployeeLoanHd = transEmployeeLoanHdDao.Get(Convert.ToInt32(hdnTransactionID.Value));
                transEmployeeLoanHd.GCTransactionStatus = Constant.TransactionStatus.VOID;
                transEmployeeLoanHd.LastUpdatedBy = AppSession.UserLogin.UserID;
                transEmployeeLoanHdDao.Update(transEmployeeLoanHd);
