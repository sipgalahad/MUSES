...
namespace CodeX.Muses.Web.ControlPanel.Program
{
    public partial class EmployeeList : BasePageList
    {
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetvEmployeeRowIndex(filterExpression, keyValue, "Name ASC") + 1;
        ...
        private string GetFilterExpression()
        {
            ...
            filterExpression += string.Format("SiteID IN (SELECT SiteID FROM vSite WHERE DisplayPath LIKE '%/{0}/%') AND GCEmployeeType = '{1}' AND IsDeleted = 0", AppSession.UserLogin.SiteID, Constant.EmployeeType.OTHER);
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            List<vEmployee> lstEntity = BusinessLayer.GetvEmployeeList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex, "Name ASC");
