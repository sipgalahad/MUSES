<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="JobLevelWorkYearsList.aspx.cs" Inherits="CodeX.Muses.Web.ControlPanel.Program.JobLevelWorkYearsList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript" >
        ...
        $('.lnkDetail a').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/Master/JobLevelWorkYears/JobLevelWorkYearsEntryCtl.ascx");
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="FromWorkYears" HeaderText="Tahun Mulai" HeaderStyle-Width="150px" />
                                <asp:BoundField DataField="ToWorkYears" HeaderText="Tahun Berakhir" HeaderStyle-Width="150px"/>
