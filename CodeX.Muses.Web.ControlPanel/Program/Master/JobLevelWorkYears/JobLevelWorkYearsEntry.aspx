...
CodeBehind="JobLevelWorkYearsEntry.aspx.cs" Inherits="CodeX.Muses.Web.ControlPanel.Program.JobLevelWorkYearsEntry" %>
            ...
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent" style="width:50%">
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtJobLevelWorkYearsName" Width="300px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Tanggal Mulai")%></label></td>
                        <td><asp:TextBox ID="txtFromWorkYears" Width="120px" CssClass="number" runat="server" /></td>
                    </tr>  
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Tanggal Berakhir")%></label></td>
                        <td><asp:TextBox ID="txtToWorkYears" Width="120px" CssClass="number" runat="server" /></td>
                    </tr>  
                    <tr>
