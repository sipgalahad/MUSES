...
namespace CodeX.Muses.Web.ControlPanel.Program
{
    public partial class ClassTypeExtracurricularList : BasePageList
    {
        ...
        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            ...
            if (keyValue != "")
            {
                int row = BusinessLayer.GetvClassTypeRowIndex(filterExpression, keyValue, "ClassTypeCode") + 1;
        ...
        public override void SetFilterParameter(ref string[] fieldListText, ref string[] fieldListValue)
        {
            ...
            fieldListValue = new string[] { "ClassTypeCode", "ClassTypeName" };
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            if (isCountPageCount)
            {
                rowCount = BusinessLayer.GetvClassTypeRowCount(filterExpression);
                pageCount = Helper.GetPageCount(rowCount, Constant.GridViewPageSize.GRID_MASTER);
            }

            List<vClassType> lstEntity = BusinessLayer.GetvClassTypeList(filterExpression, Constant.GridViewPageSize.GRID_MASTER, pageIndex, "ClassTypeCode");
        ...
        {
            url = ResolveUrl(string.Format("~/Program/Master/ClassType/ClassTypeEntry.aspx?id=add|{0}|ex", cboSchoolType.Value));
            return true;
        }
