<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RoomSiteEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.RoomSiteEntryCtl" %>
...
<script type="text/javascript" id="dxss_drugslogisticsquickpicksctl">
    ...
    $('#<%=grdView.ClientID %> .chkIsSelected input').live('change', function () {
        if ($(this).is(':checked')) {
            ...
            $newTr = $newTr.replace(/\$\{SiteID}/g, $selectedTr.find('.tdSiteID').html());
...
<div style="padding:10px;">
    ...
    <table class="tblEntryContent" style="width:70%">
        ...
        <tr>
            ...
            <td><asp:TextBox ID="txtRoomName" ReadOnly="true" Width="200px" runat="server" /></td>
        </tr> 
    </table>
                            ...
                            <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                                ...
                                OnRowDataBound="grdView_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="SiteID" HeaderText="Kode" ItemStyle-CssClass="tdSiteID" HeaderStyle-Width="50px" />
                        ...
                        <asp:Repeater ID="rptSelected" runat="server">
                            <ItemTemplate>
                                <tr class="trSelectedItem">
                                    ...
                                    <td class="tdSiteID"><%#Eval("SiteID") %></td>
                                    <td><%#Eval("SiteName") %></td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
