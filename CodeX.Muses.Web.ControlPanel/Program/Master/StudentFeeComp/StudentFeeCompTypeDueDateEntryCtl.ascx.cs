...
{
    public partial class StudentFeeCompTypeDueDateEntryCtl : BaseViewPopupCtl
    {
        ...
        {
            grdView.DataSource = BusinessLayer.GetStudentFeeCompTypeDueDateList(string.Format("StudentFeeCompTypeID = {0} AND IsDeleted = 0 ORDER BY DisplayOrder ASC", hdnID.Value));
            grdView.DataBind();
        }
        ...
        private void ControlToEntity(StudentFeeCompTypeDueDate entity)
        {
            entity.DisplayOrder = Convert.ToInt16(txtDisplayOrder.Text);
            entity.PaymentDate = Convert.ToInt32(txtDay.Text);
            entity.PaymentMonth = Convert.ToInt32(cboMonth.Value);
        }
        ...
        private bool OnSaveAddRecordEntityDt(ref string errMessage)
        {
            ...
            StudentFeeCompTypeDueDateDao entityDao = new StudentFeeCompTypeDueDateDao(ctx);
            try
            {
                StudentFeeCompTypeDueDate entity = new StudentFeeCompTypeDueDate();
        ...
        private bool OnSaveEditRecordEntityDt(ref string errMessage)
        {
            ...
            try
            {
                StudentFeeCompTypeDueDate entity = entityDao.Get(Convert.ToInt32(hdnEntryID.Value));
                ControlToEntity(entity);
        ...
        private bool OnDeleteEntityDt(ref string errMessage)
        {
            try
            {
                StudentFeeCompTypeDueDate entity = BusinessLayer.GetStudentFeeCompTypeDueDate(Convert.ToInt32(hdnEntryID.Value));
                entity.IsDeleted = true;
                entity.LastUpdatedBy = AppSession.UserLogin.UserID;
                BusinessLayer.UpdateStudentFeeCompTypeDueDate(entity);
                return true;
            }
            catch (Exception ex)
            {
