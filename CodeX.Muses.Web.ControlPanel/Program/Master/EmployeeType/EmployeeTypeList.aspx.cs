...
{
    public partial class EmployeeTypeList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.ControlPanel.EMPLOYEE_TYPE;
        }

        protected override void InitializeDataControl(string filterExpression, string keyValue)
        {
            hdnParentID.Value = Constant.StandardCode.EMPLOYEE_TYPE;
        ...
        {
            url = ResolveUrl(string.Format("~/Program/Master/EmployeeType/EmployeeTypeEntry.aspx"));
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/EmployeeType/EmployeeTypeEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
