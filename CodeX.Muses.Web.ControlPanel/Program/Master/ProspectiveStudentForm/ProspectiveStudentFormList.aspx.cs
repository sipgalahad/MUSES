...
namespace CodeX.Muses.Web.ControlPanel.Program
{
    public partial class ProspectiveStudentFormList : BasePageList
    {
        ...
        {
            fieldListText = new string[] { "Form Code", "Form Name" };
            fieldListValue = new string[] { "FormCode", "FormName" };
        }
        ...
        {
            url = ResolveUrl("~/Program/Master/ProspectiveStudentForm/ProspectiveStudentFormEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/ProspectiveStudentForm/ProspectiveStudentFormEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
