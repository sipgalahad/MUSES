...
{
    public partial class RenumerationList : BasePageList
    {
        ...
        {
            url = ResolveUrl("~/Program/Master/Renumeration/RenumerationEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/Renumeration/RenumerationEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
