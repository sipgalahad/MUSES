...
<script type="text/javascript" id="dxss_serviceunitsiteentryctl">
    $(function () {
        $('#divTransactionAddPopup').click(function () {
            tacSubject.setValue('');
            tacSubject.setText('');
            $('#<%=hdnSubjectID.ClientID %>').val('');
            cboSite.SetValue($('#<%=hdnDefaultSite.ClientID %>').val());
        ...
        openSearchDialog('subject', onGetSubjectFilterExpression(), function (value) {
            ...
            Methods.getObject('GetSubjectList', filterExpression, function (result) {
                if (result != null) {
                    ...
                    $('#<%=hdnSubjectID.ClientID %>').val(result.SubjectID);
                }
                else {
                    tacSubject.setValue('');
                    tacSubject.setText('');
    ...
    function onTacSubjectValueChanged() {
        $('#<%=hdnSubjectID.ClientID %>').val(tacSubject.getValue());
    }
    //#endregion
...
<div style="height:440px; overflow-y:auto">
    ...
    <input type="hidden" id="hdnDefaultSite" value="" runat="server" />    
            ...
            <fieldset id="fsTrxPopup" style="margin:0"> 
                <table>
                    ...
                    <tr>
                        ...
                        <td><dxe:ASPxComboBox ID="cboSite" ClientInstanceName="cboSite" Width="150px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td> 
            ...
            <dx:PanelContent ID="PanelContent1" runat="server">
                <asp:Panel runat="server" ID="pnlPatientVisitTransHdGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                    <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                        <Columns>
                            <asp:BoundField DataField="SubjectName" HeaderText="Pelajaran"  />
                            <asp:BoundField DataField="SiteName" HeaderText="Site" HeaderStyle-Width="150px" />
