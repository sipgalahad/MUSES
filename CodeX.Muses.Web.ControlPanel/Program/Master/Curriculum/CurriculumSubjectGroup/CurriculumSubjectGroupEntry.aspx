<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPCurriculumPageTrxVisit.master" AutoEventWireup="true" 
    CodeBehind="CurriculumSubjectGroupEntry.aspx.cs" Inherits="CodeX.Muses.Web.ControlPanel.Program.CurriculumSubjectGroupEntry" %>
                        ...
                        <td valign="top">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><asp:TextBox ID="txtCurriculumSubjectGroupCode" runat="server" Width="200px" /></td>
                                </tr>
                                <tr>
                ...
                <dx:PanelContent ID="PanelContent1" runat="server">
                    <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                        ...
                        <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                            ...
                            <Columns>
                                <asp:BoundField DataField="CurriculumSubjectGroupCode" HeaderText="Kode" HeaderStyle-Width="100px" />
                                <asp:BoundField DataField="CurriculumSubjectGroupName" HeaderText="Nama" HeaderStyle-Width="200px" />
