<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CurriculumMarkTypeDtEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.CurriculumMarkTypeDtEntryCtl" %>
...
<script type="text/javascript" id="dxss_serviceunitsiteentryctl">
    $(function () {
        $('#divTransactionAddPopup').click(function () {
            ...
            $('#<%=txtCurriculumMarkTypeDtName.ClientID %>').focus();
        });
    ...
    function onCboGCCurriculumMarkTypeDtValueChanged() {
        cbpViewPopup.PerformCallback('refresh');
    }
</script>
...
<div style="height:440px; overflow-y:auto">
    ...
    <table class="tblEntryContent" style="width:70%">
        ...
        <tr>
            ...
            <td><asp:TextBox ID="txtCurriculumMarkTypeName" ReadOnly="true" Width="200px" runat="server" /></td>
        </tr> 
    </table>
            ...
            <dx:PanelContent ID="PanelContent1" runat="server">
                <asp:Panel runat="server" ID="pnlPatientVisitTransHdGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                    <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                        <Columns>
                            <asp:BoundField DataField="CurriculumMarkTypeDtName" HeaderText="Nama" />
                            <asp:CheckBoxField DataField="IsExam" HeaderText="Ujian" HeaderStyle-Width="80px" HeaderStyle-CssClass="thCenter" ItemStyle-HorizontalAlign="Center" />
