<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPCurriculumPageTrxVisit.master" AutoEventWireup="true" 
    CodeBehind="CurriculumMeetingPlanEntry.aspx.cs" Inherits="CodeX.Muses.Web.ControlPanel.Program.CurriculumMeetingPlanEntry" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#divTransactionAdd').click(function (evt) {
                ...
                $('#<%=txtCurriculumMeetingPlanName.ClientID %>').val('');
                cboCurriculumMeetingPlanType.SetValue('');
        ...
        function onTacParentButtonSearchClick() {
            openSearchDialog('curriculummeetingplan', onGetParentFilterExpression(), function (value) {
                var filterExpression = onGetParentFilterExpression() + " AND CurriculumMeetingPlanID = '" + value + "'";
                Methods.getObject('GetCurriculumMeetingPlanList', filterExpression, function (result) {
                    if (result != null) {
                        tacParent.setValue(result.CurriculumMeetingPlanID);
                        tacParent.setText(result.CurriculumMeetingPlanName);
                    }
                    else {
                        tacParent.setValue('');
                        tacParent.setText('');
        ...
        function onTacReferenceButtonSearchClick() {
            openSearchDialog('curriculumsyllabus', onGetReferenceFilterExpression(), function (value) {
                ...
                Methods.getObject('GetCurriculumSyllabusPlanList', filterExpression, function (result) {
                    if (result != null) {
        ...
        $('#<%=grdView.ClientID %> .divDetailDelete').live('click', function () {
            ...
            showToastConfirmation("Are You Sure Want To Delete This Data?", function (result) {
                if (result) {
                    ...
                    $('#<%=hdnEntryID.ClientID %>').val(entity.CurriculumMeetingPlanID);
        ...
        $('#<%=grdView.ClientID %> .divDetailEdit').live('click', function () {
            ...
            $('#<%=hdnEntryID.ClientID %>').val(entity.CurriculumMeetingPlanID);
            $('#<%=txtCurriculumMeetingPlanName.ClientID %>').val(entity.CurriculumMeetingPlanName);
            cboCurriculumMeetingPlanType.SetValue(entity.GCCurriculumMeetingPlanType);
            $('#<%=txtDisplayOrder.ClientID %>').val(entity.DisplayOrder);
            tacParent.setValue(entity.ParentID);
            tacParent.setText(entity.ParentName);
            tacReference.setValue(entity.CurriculumSyllabusReferenceID);
            tacReference.setText(entity.CurriculumSyllabusReferenceName);
                        ...
                        <td valign="top">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><asp:TextBox ID="txtCurriculumMeetingPlanName" runat="server" Width="200px" /></td>
                                </tr>
                                <tr>
                                    <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Tipe")%></label></td>
                                    <td><dxe:ASPxComboBox ID="cboCurriculumMeetingPlanType" ClientInstanceName="cboCurriculumMeetingPlanType" runat="server" Width="200px" /></td>
                                </tr>
                                <tr>
                                    <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Kode Induk")%></label></td>
                                    <td>
                                        <cdx:CodeXAutoCompleteTextBox runat="server" Width="300px" ID="tacParent" ClientInstanceName="tacParent" MethodName="GetCurriculumMeetingPlanList" GetFilterExpressionFunction="onGetParentFilterExpression"
                                            SearchFields="CurriculumMeetingPlanName" TextField="CurriculumMeetingPlanName" ValueField="CurriculumMeetingPlanID" SearchText="${CurriculumMeetingPlanName}" OrderByExpression="CurriculumMeetingPlanName">
                        ...
                        <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-Width="200px" >
                                    ...
                                    <ItemTemplate>
                                        <div style='margin-left:<%# Eval("Level") %>0px;'><%# Eval("CurriculumMeetingPlanName") %></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="CurriculumMeetingPlanType" HeaderText="Tipe" HeaderStyle-Width="150px" />
                                <asp:TemplateField HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <div style='float:right;' class="divDetailDelete"></div>
                                        <div style='float:right;margin-right:10px;' class="divDetailEdit"><%=GetLabel("Edit")%></div>
                                        <input type="hidden" value="<%#Eval("CurriculumMeetingPlanID") %>" bindingfield="CurriculumMeetingPlanID" />
                                        <input type="hidden" value="<%#Eval("CurriculumMeetingPlanName") %>" bindingfield="CurriculumMeetingPlanName" />
                                        ...
                                        <input type="hidden" value="<%#Eval("CurriculumSyllabusReferenceID") %>" bindingfield="CurriculumSyllabusReferenceID" />
                                        <input type="hidden" value="<%#Eval("CurriculumSyllabusReferenceName") %>" bindingfield="CurriculumSyllabusReferenceName" />
                                        <input type="hidden" value="<%#Eval("GCCurriculumMeetingPlanType") %>" bindingfield="GCCurriculumMeetingPlanType" />
