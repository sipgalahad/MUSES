<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PersonalitySchoolSubjectEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.PersonalitySchoolSubjectEntryCtl" %>
