<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MPSubjectPageTrxVisit.master" AutoEventWireup="true" 
    CodeBehind="SubjectCurriculumEntry.aspx.cs" Inherits="CodeX.Muses.Web.ControlPanel.Program.SubjectCurriculumEntry" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#divTransactionAdd').click(function (evt) {
                ...
                cboCurriculum.SetEnabled(false);
