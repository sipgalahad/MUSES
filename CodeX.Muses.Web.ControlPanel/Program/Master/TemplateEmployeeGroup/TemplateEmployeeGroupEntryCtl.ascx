<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TemplateEmployeeGroupEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.TemplateEmployeeGroupEntryCtl" %>
    ...
    $('#<%=grdView.ClientID %> .divDetailDelete').live('click', function () {
        ...
        showToastConfirmation("Are You Sure Want To Delete This Data?", function (result) {
            if (result) {
                ...
                $('#<%=hdnEntryID.ClientID %>').val(entity.TemplateID);
                $('#<%=hdnEmployeeIDDelete.ClientID %>').val(entity.EmployeeID);
...
//        tacEmployeeID.setText(entity.EmployeeName);
        ...
        openSearchDialog('employee', onGetEmployeeFilterExpression(), function (value) {
            ...
            Methods.getObject('GetvEmployeeList', filterExpression, function (result) {
                if (result != null) {
                    ...
                    tacEmployeeID.setText(result.EmployeeName);
                }
                else {
                    $('#<%=hdnEmployeeID.ClientID %>').val('');
                    tacEmployeeID.setValue('');
...
<div style="height:440px; overflow-y:auto">
    ...
    <input type="hidden" id="hdnEmployeeIDDelete" value="" runat="server" />
            ...
            <fieldset id="fsTrxPopup" style="margin:0"> 
                ...
                <table>
                    <colgroup>
                     ...
                     <tr>
                         <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Karyawan")%></label></td>
                         <td>
                            <input type="hidden" id="hdnEmployeeID" runat="server" />
                            <cdx:CodeXAutoCompleteTextBox runat="server" Width="200px" ID="tacEmployeeID" ClientInstanceName="tacEmployeeID" MethodName="GetvEmployeeList" GetFilterExpressionFunction="onGetEmployeeFilterExpression"
