...
{
    public partial class StandardCodePerHdList : BasePageList
    {
        ...
        {
            url = ResolveUrl(string.Format("~/Program/Master/StandardCodePerHd/StandardCodePerHdEntry.aspx?id=add|{0}", hdnParentID.Value));
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/StandardCodePerHd/StandardCodePerHdEntry.aspx?id=edit|{0}", hdnID.Value));
                return true;
            }
            return false;
        }
