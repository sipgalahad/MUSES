...
namespace CodeX.Muses.Web.ControlPanel.Program
{
    public partial class CustomerEntry : BasePageEntry
    {
        ...
        protected override void InitializeDataControl()
        {
            ...
            ctlEntityCode.InitializeMasterCodingControl(Constant.MasterCode.CUSTOMER);
        ...
        {
            List<StandardCode> listStandardCode = BusinessLayer.GetStandardCodeList(string.Format("ParentID = '{0}' AND IsActive = 1 AND IsDeleted = 0", Constant.StandardCode.CUSTOMER_TYPE));
        ...
        private void ControlToEntity(IDbContext ctx, BusinessPartners entity, Customer entityCus, Address entityAddress, BusinessPartnerTagField entityTagField)
        {
            #region General Information
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            try
            {
                ...
                ControlToEntity(ctx, entity, entityCus, entityAddress, entityTagField);
