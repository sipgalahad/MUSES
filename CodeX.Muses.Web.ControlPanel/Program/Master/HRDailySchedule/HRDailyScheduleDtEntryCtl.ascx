<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HRDailyScheduleDtEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.HRDailyScheduleDtEntryCtl" %>
            ...
            <dx:PanelContent ID="PanelContent1" runat="server">
                <asp:Panel runat="server" ID="pnlPatientVisitTransHdGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                    <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                        <Columns>
                            <asp:BoundField DataField="DailyScheduleDtID" HeaderStyle-CssClass="keyField" ItemStyle-CssClass="keyField" />
                            <asp:BoundField DataField="FromHour" HeaderText="Jam Mulai" HeaderStyle-CssClass="thCenter" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" />
                            <asp:BoundField DataField="ToHour" HeaderText="Jam Selesai" HeaderStyle-CssClass="thCenter" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" />
                            <asp:BoundField DataField="DailyScheduleType" HeaderText="Tipe Jadwal"  />
                            <asp:TemplateField HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <div style='float:right;' class="divDetailDelete"></div>
                                    <div style='float:right;margin-right:10px;' class="divDetailEdit"><%=GetLabel("Edit")%></div>
                                    <input type="hidden" value="<%#Eval("DailyScheduleDtID") %>" bindingfield="DailyScheduleDtID" />
                                    <input type="hidden" value="<%#Eval("FromHour") %>" bindingfield="FromHour" />
                                    <input type="hidden" value="<%#Eval("ToHour") %>" bindingfield="ToHour" />
