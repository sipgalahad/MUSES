...
{
    public partial class TeacherMarkTypeGroupList : BasePageList
    {
        ...
        public override void SetFilterParameter(ref string[] fieldListText, ref string[] fieldListValue)
        {
            ...
            fieldListValue = new string[] { "TeacherMarkTypeGroupName" };
        }
        ...
        {
            url = ResolveUrl("~/Program/Master/TeacherMarkTypeGroup/TeacherMarkTypeGroupEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/Master/TeacherMarkTypeGroup/TeacherMarkTypeGroupEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
        ...
        protected override bool OnDeleteRecord(ref string errMessage)
        {
            if (hdnID.Value.ToString() != "")
            {
                ...
                BusinessLayer.UpdateTeacherMarkTypeGroup(entity);
                return true;
            }
            return false;
        }
