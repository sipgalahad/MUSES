<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PerformanceIndicatorEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.PerformanceIndicatorEntryCtl" %>
...
<script type="text/javascript" id="dxss_serviceunitsiteentryctl">
    $(function () {
        $('#divTransactionAddPopup').click(function () {
            ...
            $('#<%=txtPerformanceIndicatorDtName.ClientID %>').val('');
    ...
    $('#<%=grdView.ClientID %> .divDetailEdit').live('click', function () {
        ...
        $('#<%=hdnEntryID.ClientID %>').val(entity.PerformanceIndicatorDt);
        $('#<%=txtPerformanceIndicatorDtName.ClientID %>').val(entity.PerformanceIndicatorDtName);
        ...
        <div id="entryDetailContainerPopup" class="entryDetailContainer" style="display: none">
            <fieldset id="fsTrxPopup" style="margin:0"> 
                ...
                <table>
                    ...
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Nama")%></label></td>
                        <td><asp:TextBox ID="txtPerformanceIndicatorDtName"  Width="200px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Display Order")%></label></td>
                        <td><asp:TextBox ID="txtDisplayOrder" CssClass="number" runat="server" /></td>
                    </tr>
