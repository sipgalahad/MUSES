<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceUnitItemLogisticLogisticQuickPicksEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.ServiceUnitItemLogisticQuickPicksEntryCtl" %>
