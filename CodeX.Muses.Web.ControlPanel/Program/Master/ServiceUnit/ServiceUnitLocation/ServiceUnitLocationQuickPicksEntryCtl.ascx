<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceUnitLocationQuickPicksEntryCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.Program.ServiceUnitLocationQuickPicksEntryCtl" %>
