<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="ServiceUnitList.aspx.cs" Inherits="CodeX.Muses.Web.ControlPanel.Program.ServiceUnitList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('.lnkSite a').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/Master/ServiceUnit/ServiceUnitSiteEntryCtl.ascx");
            openUserControlPopup(url, id, 'Unit Pelayanan Per Site', 900, 500);
        });
    </script>
