<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="DataMigrationList.aspx.cs" Inherits="CodeX.Muses.Web.ControlPanel.Program.DataMigrationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhCustomButtonToolbar" runat="server">
    <li id="btnDataMigrationGo" runat="server" CRUDMode="R"><img src='<%=ResolveUrl("~/Libs/Images/Icon/list.png")%>' alt="" /><br style="clear:both"/><div><%=GetLabel("Go")%></div></li> 
</asp:Content>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnDataMigrationGo.ClientID %>').click(function () {
                ...
                if (id != '') {
                    var url = ResolveUrl("~/Program/ProcessUtilities/DataUtilities/DataMigrationTool/DataMigration.aspx?id=" + id);
