<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="DataMigrationConfigurationList.aspx.cs" Inherits="CodeX.Muses.Web.ControlPanel.Program.DataMigrationConfigurationList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnDataMigrationColumnMap.ClientID %>').click(function () {
                ...
                if (id != '') {
                    var url = ResolveUrl("~/Program/ProcessUtilities/DataUtilities/DataMigrationConfiguration/DataMigrationConfigurationColumnMapList.aspx?id=" + id);
        ...
        $('.lnkTableLink a').live('click', function () {
            ...
            var url = ResolveUrl("~/Program/ProcessUtilities/DataUtilities/DataMigrationConfiguration/DataMigrationTableLinkCtl.ascx");
