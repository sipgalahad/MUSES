...
namespace CodeX.Muses.Web.ControlPanel.Program
{
    public partial class TransactionNumberingList : BasePageList
    {
        ...
        {
            url = ResolveUrl("~/Program/ControlPanel/SystemConfiguration/TransactionNumbering/TransactionNumberingEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/ControlPanel/SystemConfiguration/TransactionNumbering/TransactionNumberingEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
