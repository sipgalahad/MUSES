...
namespace CodeX.Muses.Web.ControlPanel.Program
{
    public partial class SettingParameterList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.ControlPanel.SETTING_PARAMETER;
        }
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            if (isCountPageCount)
            {
                rowCount = BusinessLayer.GetSettingParameterRowCount(filterExpression);
        ...
        {
            url = ResolveUrl("~/Program/ControlPanel/SystemConfiguration/SettingParameter/SettingParameterEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/ControlPanel/SystemConfiguration/SettingParameter/SettingParameterEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
