...
namespace CodeX.Muses.Web.SystemSetup.Program
{
    public partial class ZipCodesList : BasePageList
    {
        ...
        private void BindGridView(int pageIndex, bool isCountPageCount, ref int pageCount, ref int rowCount)
        {
            ...
            if (isCountPageCount)
            {
                rowCount = BusinessLayer.GetZipCodesRowCount(filterExpression);
        ...
        {
            url = ResolveUrl("~/Program/ControlPanel/SystemConfiguration/ZipCodes/ZipCodesEntry.aspx");
            return true;
        }
        ...
        protected override bool OnEditRecord(ref string url, ref string errMessage)
        {
            ...
            {
                url = ResolveUrl(string.Format("~/Program/ControlPanel/SystemConfiguration/ZipCodes/ZipCodesEntry.aspx?id={0}", hdnID.Value));
                return true;
            }
            return false;
        }
