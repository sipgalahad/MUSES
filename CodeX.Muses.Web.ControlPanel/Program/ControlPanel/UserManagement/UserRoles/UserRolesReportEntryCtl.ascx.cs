...
namespace CodeX.Muses.Web.ControlPanel.Program
{
    public partial class UserRolesReportEntryCtl : BaseViewPopupCtl
    {
        ...
        public override void InitializeDataControl(string param)
        {
            ...
            List<UserRoleReport> lstReport = BusinessLayer.GetUserRoleReportList(string.Format("RoleID = {0} AND SiteID = '{1}'", hdnRoleID.Value, AppSession.UserLogin.SiteID));
        ...
        private bool SaveData(ref string errMessage)
        {
            ...
            try
            {
                foreach (String oldData in lstOldReport)
                {
                    ...
                    {
                        BusinessLayer.DeleteUserRoleReport(roleID, AppSession.UserLogin.SiteID, Convert.ToInt32(oldData));
                    }
                }
