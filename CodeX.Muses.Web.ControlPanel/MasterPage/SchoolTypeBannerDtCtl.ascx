<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SchoolTypeBannerDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.MasterPage.SchoolTypeBannerDtCtl" %>
