<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SiteServiceUnitBannerDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.ControlPanel.MasterPage.SiteServiceUnitBannerDtCtl" %>
