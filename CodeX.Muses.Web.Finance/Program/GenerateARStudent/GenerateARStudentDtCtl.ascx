<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GenerateARStudentDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.Finance.Program.GenerateARStudentDtCtl" %>
            ...
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><asp:TextBox ID="txtStudent" ReadOnly="true" Width="400px" runat="server" /></td>
                    </tr>  
                    <tr>
