<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="PaymentMethodEdit.aspx.cs" Inherits="CodeX.Muses.Web.Finance.Program.PaymentMethodEdit" %>
            ...
            <colgroup>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <cdx:CodeXAutoCompleteTextBox runat="server" Width="200px" ID="tacStudent" ClientInstanceName="tacStudent" MethodName="GetvStudentList" GetFilterExpressionFunction="onGetStudentFilterExpression"
                            SearchFields="StudentName,VirtualAccountNo" TextField="StudentName" ValueField="StudentID" SearchText="${StudentName} (<b>${VirtualAccountNo}</b>)" OrderByExpression="ProspectiveStudentName">
