<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GenerateARProspectiveStudentDtCtl.ascx.cs" 
    Inherits="CodeX.Muses.Web.Finance.Program.GenerateARProspectiveStudentDtCtl" %>
            ...
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><asp:TextBox ID="txtProspectiveStudent" ReadOnly="true" Width="400px" runat="server" /></td>
                    </tr>  
                    <tr>
                        <td class="tdLabel"><label class="lblNormal"><%=GetLabel("Periode")%></label></td>
                        <td colspan="2"><asp:TextBox ID="txtPeriod" ReadOnly="true" Width="400px" runat="server" /></td>
                    </tr>  
                </table>
                            ...
                            <asp:Panel runat="server" ID="pnlEntryPopupGrdView" Style="width: 100%; margin-left: auto; margin-right: auto; position: relative;font-size:0.95em;">
                                <asp:GridView ID="grdView" runat="server" CssClass="tblTransactionEntryResult"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="StudentAmount" HeaderText="SubTotal" ItemStyle-HorizontalAlign="Right" HeaderStyle-CssClass="thRight" HeaderStyle-Width="90px" DataFormatString="{0:N}" />
                                    </Columns>
                                    <EmptyDataTemplate>
