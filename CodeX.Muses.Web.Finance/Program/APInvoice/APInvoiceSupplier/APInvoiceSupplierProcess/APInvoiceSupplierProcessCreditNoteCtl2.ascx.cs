...
{
    public partial class APInvoiceSupplierProcessCreditNoteCtl2 : BaseEntryPopupCtl
    {
        public override void InitializeDataControl(string param)
        {
            ...
            txtReturnAmount.Text = entityReturnHd.TotalNetTransactionAmount.ToString();
        ...
        protected override bool OnSaveAddRecord(ref string errMessage, ref string retval)
        {
            ...
            try
            {
                ...
                purchaseInvoiceDt.CreditNoteID = entity.CreditNoteID;
