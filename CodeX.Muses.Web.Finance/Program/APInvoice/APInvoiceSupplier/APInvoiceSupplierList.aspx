<%@ Page Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master" AutoEventWireup="true" 
    CodeBehind="APInvoiceSupplierList.aspx.cs" Inherits="CodeX.Muses.Web.Finance.Program.APSupplierList" %>
                    ...
                    <asp:Panel runat="server" ID="pnlView" CssClass="pnlContainerGrid" Style="overflow-y: scroll;">
                        <asp:GridView ID="grdView" runat="server" CssClass="grdSelected" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="trEmpty">
                            <Columns>
                                ...
                                <asp:BoundField DataField="BusinessPartnerCode" HeaderText="Kode Supplier" HeaderStyle-Width="150px" />
                                <asp:BoundField DataField="BusinessPartnerName" HeaderText="Nama Supplier" />
                                <asp:BoundField DataField="ShortName" HeaderText="Nama Singkat"  HeaderStyle-Width="250px" />
                                <asp:HyperLinkField HeaderText="Proses" Text="Proses" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="lnkProcess" HeaderStyle-Width="120px" HeaderStyle-CssClass="thCenter" />
                            </Columns>
                            <EmptyDataTemplate>
