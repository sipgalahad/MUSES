    ...
    public partial class GenerateUploadFileStudent : BasePageTrx
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SchoolPeriod Period = BusinessLayer.GetSchoolPeriodList(String.Format("(StartDate <= '{0}' AND EndDate >= '{0}') AND (StartDate <= '{1}' AND EndDate >= '{1}') AND SiteID = '{2}'", Helper.GetDatePickerValue(txtStartDate.Text), Helper.GetDatePickerValue(txtEndDate.Text), AppSession.SiteID), ctx)[0];
