...
{
    public partial class ARInvoiceCustomerList : BasePageList
    {
        ...
        {
            return Constant.MenuCode.Finance.CUSTOMER_LIST;
        }
        ...
        private string GetFilterExpression()
        {
            ...
            filterExpression += String.Format("GCBusinessPartnerType = '{0}' AND (SiteID = '{1}' OR SiteID IS NULL) AND IsDeleted = 0", Constant.BusinessObjectType.CUSTOMER, AppSession.UserLogin.SiteID);
