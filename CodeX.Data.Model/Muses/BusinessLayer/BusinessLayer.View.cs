...
namespace CodeX.Data.Model
{
    public static partial class BusinessLayer
    {
        ...
        public static Int32 GetvClassMeetingAttendanceRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vClassMeetingAttendance> GetvClassMeetingAttendanceList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vClassMeetingAttendance> result = new List<vClassMeetingAttendance>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vEmployeeRenumeration> GetvEmployeeRenumerationList(string filterExpression, IDbContext ctx)
        {
            List<vEmployeeRenumeration> result = new List<vEmployeeRenumeration>();
            try
            {
        ...
        public static List<vEmployeePerformanceIndicator> GetvEmployeePerformanceIndicatorList(string filterExpression)
        {
            List<vEmployeePerformanceIndicator> result = new List<vEmployeePerformanceIndicator>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vEmployeePerformanceIndicator));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vEmployeePerformanceIndicator)helper.IDataReaderToObject(reader, new vEmployeePerformanceIndicator()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vEmployeePerformanceIndicator> GetvEmployeePerformanceIndicatorList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vEmployeePerformanceIndicator> result = new List<vEmployeePerformanceIndicator>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvEmployeePerformanceIndicatorRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vFAItemDt
        public static List<vFAItemDt> GetvFAItemDtList(string filterExpression)
        {
            List<vFAItemDt> result = new List<vFAItemDt>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vFAItemDt));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vFAItemDt)helper.IDataReaderToObject(reader, new vFAItemDt()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vFAItemDt> GetvFAItemDtList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vFAItemDt> result = new List<vFAItemDt>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvFAItemDtRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvFAItemDtRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vJobLevelPosition> GetvJobLevelPositionList(string filterExpression)
        {
            List<vJobLevelPosition> result = new List<vJobLevelPosition>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vJobLevelPosition));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vJobLevelPosition)helper.IDataReaderToObject(reader, new vJobLevelPosition()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vJobLevelPosition> GetvJobLevelPositionList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vJobLevelPosition> result = new List<vJobLevelPosition>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvJobLevelPositionRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvJobLevelPositionRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vJobLevelPosition));
                ctx.CommandText = helper.GetRowIndex(filterExpression, "JobLevelPositionID", keyValue, orderByExpression);
                DataRow row = DaoBase.GetDataRow(ctx);
                result = Convert.ToInt32(row.ItemArray.GetValue(0));
            }
            catch (Exception ex)
        ...
        #endregion
        #region vJobLevelPerformanceIndicatorDt
        public static List<vJobLevelPerformanceIndicatorDt> GetvJobLevelPerformanceIndicatorDtList(string filterExpression)
        {
            List<vJobLevelPerformanceIndicatorDt> result = new List<vJobLevelPerformanceIndicatorDt>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vJobLevelPerformanceIndicatorDt));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vJobLevelPerformanceIndicatorDt)helper.IDataReaderToObject(reader, new vJobLevelPerformanceIndicatorDt()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        #endregion
        #region vJobLevelPerformanceIndicatorDtIndicator
        public static List<vJobLevelPerformanceIndicatorDtIndicator> GetvJobLevelPerformanceIndicatorDtIndicatorList(string filterExpression)
        {
            List<vJobLevelPerformanceIndicatorDtIndicator> result = new List<vJobLevelPerformanceIndicatorDtIndicator>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vJobLevelPerformanceIndicatorDtIndicator));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vJobLevelPerformanceIndicatorDtIndicator)helper.IDataReaderToObject(reader, new vJobLevelPerformanceIndicatorDtIndicator()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        #endregion
        #region vJobLevelWorkYearsDt
        public static List<vJobLevelWorkYearsDt> GetvJobLevelWorkYearsDtList(string filterExpression)
        {
            List<vJobLevelWorkYearsDt> result = new List<vJobLevelWorkYearsDt>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vJobLevelWorkYearsDt));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vJobLevelWorkYearsDt)helper.IDataReaderToObject(reader, new vJobLevelWorkYearsDt()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        #endregion
        #region vPerformanceIndicatorHd
        public static List<vPerformanceIndicatorHd> GetvPerformanceIndicatorHdList(string filterExpression)
        {
            List<vPerformanceIndicatorHd> result = new List<vPerformanceIndicatorHd>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vPerformanceIndicatorHd));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vPerformanceIndicatorHd)helper.IDataReaderToObject(reader, new vPerformanceIndicatorHd()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vPerformanceIndicatorHd> GetvPerformanceIndicatorHdList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vPerformanceIndicatorHd> result = new List<vPerformanceIndicatorHd>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvPerformanceIndicatorHdRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvPerformanceIndicatorHdRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvPerformanceIndicatorHdMaxID(IDbContext ctx)
        {
            Int32 result = 0;
            try
            {
        ...
        public static List<vPurchaseBudgetDt> GetvPurchaseBudgetDtList(string filterExpression)
        {
            List<vPurchaseBudgetDt> result = new List<vPurchaseBudgetDt>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vPurchaseBudgetDt));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vPurchaseBudgetDt)helper.IDataReaderToObject(reader, new vPurchaseBudgetDt()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vPurchaseBudgetDt> GetvPurchaseBudgetDtList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vPurchaseBudgetDt> result = new List<vPurchaseBudgetDt>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvPurchaseBudgetDtRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvPurchaseBudgetDtRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vPurchaseBudgetHd> GetvPurchaseBudgetHdList(string filterExpression)
        {
            List<vPurchaseBudgetHd> result = new List<vPurchaseBudgetHd>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vPurchaseBudgetHd));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vPurchaseBudgetHd)helper.IDataReaderToObject(reader, new vPurchaseBudgetHd()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vPurchaseBudgetHd> GetvPurchaseBudgetHdList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vPurchaseBudgetHd> result = new List<vPurchaseBudgetHd>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvPurchaseBudgetHdRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvPurchaseBudgetHdRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static vPurchaseBudgetHd GetvPurchaseBudgetHd(string filterExpression, int pageIndex, string orderByExpression = "")
        {
            List<vPurchaseBudgetHd> result = new List<vPurchaseBudgetHd>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vPurchaseInvoiceDtCreditNote
        public static List<vPurchaseInvoiceDtCreditNote> GetvPurchaseInvoiceDtCreditNoteList(string filterExpression)
        {
            List<vPurchaseInvoiceDtCreditNote> result = new List<vPurchaseInvoiceDtCreditNote>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vPurchaseInvoiceDtCreditNote));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vPurchaseInvoiceDtCreditNote)helper.IDataReaderToObject(reader, new vPurchaseInvoiceDtCreditNote()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vPurchaseOrderDtOutstandingInfo> GetvPurchaseOrderDtOutstandingInfoList(string filterExpression)
        {
            List<vPurchaseOrderDtOutstandingInfo> result = new List<vPurchaseOrderDtOutstandingInfo>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vPurchaseOrderDtOutstandingInfo));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vPurchaseOrderDtOutstandingInfo)helper.IDataReaderToObject(reader, new vPurchaseOrderDtOutstandingInfo()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static Int32 GetvPurchaseOrderDtOutstandingInfoRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vPurchaseOrderDtOutstandingInfo> GetvPurchaseOrderDtOutstandingInfoList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vPurchaseOrderDtOutstandingInfo> result = new List<vPurchaseOrderDtOutstandingInfo>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vPurchaseOrderHdOutstanding> GetvPurchaseOrderHdOutstandingList(string filterExpression)
        {
            List<vPurchaseOrderHdOutstanding> result = new List<vPurchaseOrderHdOutstanding>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vPurchaseOrderHdOutstanding));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vPurchaseOrderHdOutstanding)helper.IDataReaderToObject(reader, new vPurchaseOrderHdOutstanding()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vPurchaseOrderHdOutstanding> GetvPurchaseOrderHdOutstandingList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vPurchaseOrderHdOutstanding> result = new List<vPurchaseOrderHdOutstanding>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvPurchaseOrderHdOutstandingRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vPurchaseRequestDtOutstanding> GetvPurchaseRequestDtOutstandingList(string filterExpression, IDbContext ctx)
        {
            List<vPurchaseRequestDtOutstanding> result = new List<vPurchaseRequestDtOutstanding>();
            try
            {
        ...
        public static List<vPurchaseRequestDtQtyOnOrder> GetvPurchaseRequestDtQtyOnOrderList(string filterExpression)
        {
            List<vPurchaseRequestDtQtyOnOrder> result = new List<vPurchaseRequestDtQtyOnOrder>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vPurchaseRequestDtQtyOnOrder));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vPurchaseRequestDtQtyOnOrder)helper.IDataReaderToObject(reader, new vPurchaseRequestDtQtyOnOrder()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vPurchaseRequestDtQtyOnOrder> GetvPurchaseRequestDtQtyOnOrderList(string filterExpression, IDbContext ctx)
        {
            List<vPurchaseRequestDtQtyOnOrder> result = new List<vPurchaseRequestDtQtyOnOrder>();
            try
            {
        ...
        public static Int32 GetvPurchaseRequestDtQtyOnOrderRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vPurchaseRequestDtQtyOnOrder> GetvPurchaseRequestDtQtyOnOrderList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vPurchaseRequestDtQtyOnOrder> result = new List<vPurchaseRequestDtQtyOnOrder>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Decimal GetvPurchaseRequestDtQtyOnOrderSumQtyOnOrder(string filterExpression)
        {
            Decimal result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        {
            List<vServiceUnitItemLogistic> result = new List<vServiceUnitItemLogistic>();
            try
            {
                DbHelper helper = new DbHelper(typeof(vServiceUnitItemLogistic));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vServiceUnitItemLogistic)helper.IDataReaderToObject(reader, new vServiceUnitItemLogistic()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vServiceUnitItemLogistic> GetvServiceUnitItemLogisticList(string filterExpression)
        {
            List<vServiceUnitItemLogistic> result = new List<vServiceUnitItemLogistic>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vServiceUnitItemLogistic> GetvServiceUnitItemLogisticList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vServiceUnitItemLogistic> result = new List<vServiceUnitItemLogistic>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvServiceUnitItemLogisticRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vServiceUnitItemGroup
        public static List<vServiceUnitItemGroup> GetvServiceUnitItemGroupList(string filterExpression, IDbContext ctx)
        {
            List<vServiceUnitItemGroup> result = new List<vServiceUnitItemGroup>();
            try
            {
                DbHelper helper = new DbHelper(typeof(vServiceUnitItemGroup));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vServiceUnitItemGroup)helper.IDataReaderToObject(reader, new vServiceUnitItemGroup()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vServiceUnitItemGroup> GetvServiceUnitItemGroupList(string filterExpression)
        {
            List<vServiceUnitItemGroup> result = new List<vServiceUnitItemGroup>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vServiceUnitItemGroup> GetvServiceUnitItemGroupList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vServiceUnitItemGroup> result = new List<vServiceUnitItemGroup>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvServiceUnitItemGroupRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vServiceUnitUser
        public static List<vServiceUnitUser> GetvServiceUnitUserList(string filterExpression)
        {
            List<vServiceUnitUser> result = new List<vServiceUnitUser>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vServiceUnitUser));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vServiceUnitUser)helper.IDataReaderToObject(reader, new vServiceUnitUser()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vServiceUnitUser> GetvServiceUnitUserList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vServiceUnitUser> result = new List<vServiceUnitUser>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvServiceUnitUserRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vServiceUnitUserRole
        public static List<vServiceUnitUserRole> GetvServiceUnitUserRoleList(string filterExpression)
        {
            List<vServiceUnitUserRole> result = new List<vServiceUnitUserRole>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vServiceUnitUserRole));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vServiceUnitUserRole)helper.IDataReaderToObject(reader, new vServiceUnitUserRole()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vServiceUnitUserRole> GetvServiceUnitUserRoleList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vServiceUnitUserRole> result = new List<vServiceUnitUserRole>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvServiceUnitUserRoleRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vSupplier> GetvSupplierList(string filterExpression, IDbContext ctx)
        {
            List<vSupplier> result = new List<vSupplier>();
            try
            {
        ...
        #endregion
        #region vTransEmployeeRenumerationDt
        public static List<vTransEmployeeRenumerationDt> GetvTransEmployeeRenumerationDtList(string filterExpression)
        {
            List<vTransEmployeeRenumerationDt> result = new List<vTransEmployeeRenumerationDt>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vTransEmployeeRenumerationDt));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vTransEmployeeRenumerationDt)helper.IDataReaderToObject(reader, new vTransEmployeeRenumerationDt()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static Int32 GetvTransEmployeeRenumerationDtRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vTransEmployeeRenumerationDt> GetvTransEmployeeRenumerationDtList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vTransEmployeeRenumerationDt> result = new List<vTransEmployeeRenumerationDt>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vTransEmployeeRenumerationHd
        public static List<vTransEmployeeRenumerationHd> GetvTransEmployeeRenumerationHdList(string filterExpression)
        {
            List<vTransEmployeeRenumerationHd> result = new List<vTransEmployeeRenumerationHd>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vTransEmployeeRenumerationHd));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vTransEmployeeRenumerationHd)helper.IDataReaderToObject(reader, new vTransEmployeeRenumerationHd()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static Int32 GetvTransEmployeeRenumerationHddRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static vTransEmployeeRenumerationHd GetvTransEmployeeRenumerationHd(string filterExpression, int pageIndex, string orderByExpression = "")
        {
            List<vTransEmployeeRenumerationHd> result = new List<vTransEmployeeRenumerationHd>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvTransEmployeeRenumerationHdRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvTransEmployeeRenumerationHdRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vTransEmployeeRenumerationHd> GetvTransEmployeeRenumerationHdList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vTransEmployeeRenumerationHd> result = new List<vTransEmployeeRenumerationHd>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vTransEmployeeSiteDt
        public static List<vTransEmployeeSiteDt> GetvTransEmployeeSiteDtList(string filterExpression)
        {
            List<vTransEmployeeSiteDt> result = new List<vTransEmployeeSiteDt>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vTransEmployeeSiteDt));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vTransEmployeeSiteDt)helper.IDataReaderToObject(reader, new vTransEmployeeSiteDt()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static Int32 GetvTransEmployeeSiteDtRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vTransEmployeeSiteDt> GetvTransEmployeeSiteDtList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vTransEmployeeSiteDt> result = new List<vTransEmployeeSiteDt>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vTransEmployeeSiteHd
        public static List<vTransEmployeeSiteHd> GetvTransEmployeeSiteHdList(string filterExpression)
        {
            List<vTransEmployeeSiteHd> result = new List<vTransEmployeeSiteHd>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vTransEmployeeSiteHd));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vTransEmployeeSiteHd)helper.IDataReaderToObject(reader, new vTransEmployeeSiteHd()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static Int32 GetvTransEmployeeSiteHdRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static vTransEmployeeSiteHd GetvTransEmployeeSiteHd(string filterExpression, int pageIndex, string orderByExpression = "")
        {
            List<vTransEmployeeSiteHd> result = new List<vTransEmployeeSiteHd>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvTransEmployeeSiteHdRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vTransEmployeeSiteHd> GetvTransEmployeeSiteHdList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vTransEmployeeSiteHd> result = new List<vTransEmployeeSiteHd>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vTransJobLevelPositionRenumerationDt> GetvTransJobLevelPositionRenumerationDtList(string filterExpression)
        {
            List<vTransJobLevelPositionRenumerationDt> result = new List<vTransJobLevelPositionRenumerationDt>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vTransJobLevelPositionRenumerationDt));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vTransJobLevelPositionRenumerationDt)helper.IDataReaderToObject(reader, new vTransJobLevelPositionRenumerationDt()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static Int32 GetvTransJobLevelPositionRenumerationDtRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vTransJobLevelPositionRenumerationDt> GetvTransJobLevelPositionRenumerationDtList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vTransJobLevelPositionRenumerationDt> result = new List<vTransJobLevelPositionRenumerationDt>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vTransJobLevelPositionRenumerationHd> GetvTransJobLevelPositionRenumerationHdList(string filterExpression)
        {
            List<vTransJobLevelPositionRenumerationHd> result = new List<vTransJobLevelPositionRenumerationHd>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vTransJobLevelPositionRenumerationHd));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vTransJobLevelPositionRenumerationHd)helper.IDataReaderToObject(reader, new vTransJobLevelPositionRenumerationHd()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static Int32 GetvTransJobLevelPositionRenumerationHdRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static vTransJobLevelPositionRenumerationHd GetvTransJobLevelPositionRenumerationHd(string filterExpression, int pageIndex, string orderByExpression = "")
        {
            List<vTransJobLevelPositionRenumerationHd> result = new List<vTransJobLevelPositionRenumerationHd>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvTransJobLevelPositionRenumerationHdRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static List<vTransJobLevelPositionRenumerationHd> GetvTransJobLevelPositionRenumerationHdList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vTransJobLevelPositionRenumerationHd> result = new List<vTransJobLevelPositionRenumerationHd>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vTreasuryBook
        public static List<vTreasuryBook> GetvTreasuryBookList(string filterExpression)
        {
        ...
        public static Int32 GetvTreasuryBookRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvTreasuryBookRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vTreasuryDt
        public static List<vTreasuryDt> GetvTreasuryDtList(string filterExpression)
        {
            List<vTreasuryDt> result = new List<vTreasuryDt>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vTreasuryDt));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vTreasuryDt)helper.IDataReaderToObject(reader, new vTreasuryDt()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vTreasuryDt> GetvTreasuryDtList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vTreasuryDt> result = new List<vTreasuryDt>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvTreasuryDtRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvTreasuryDtRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        #endregion
        #region vTreasuryHd
        public static List<vTreasuryHd> GetvTreasuryHdList(string filterExpression)
        {
            List<vTreasuryHd> result = new List<vTreasuryHd>();
            IDbContext ctx = DbFactory.Configure();
            try
            {
                DbHelper helper = new DbHelper(typeof(vTreasuryHd));
                ctx.CommandText = helper.Select(filterExpression);
                using (IDataReader reader = DaoBase.GetDataReader(ctx))
                    while (reader.Read())
                        result.Add((vTreasuryHd)helper.IDataReaderToObject(reader, new vTreasuryHd()));
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public static List<vTreasuryHd> GetvTreasuryHdList(string filterExpression, int numRows, int pageIndex, string orderByExpression = "")
        {
            List<vTreasuryHd> result = new List<vTreasuryHd>();
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvTreasuryHdRowCount(string filterExpression)
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static Int32 GetvTreasuryHdRowIndex(string filterExpression, string keyValue, string orderByExpression = "")
        {
            Int32 result = 0;
            IDbContext ctx = DbFactory.Configure();
            try
        ...
        public static vTreasuryHd GetvTreasuryHd(string filterExpression, int pageIndex, string orderByExpression = "")
        {
            List<vTreasuryHd> result = new List<vTreasuryHd>();
            IDbContext ctx = DbFactory.Configure();
            try
