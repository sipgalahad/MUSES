...
namespace CodeX.Data.Model
{
    ...
    public class ARInvoiceDt : DbDataModel
    {
        ...
        [Column(Name = "StudentFeeDtID", DataType = "Int32", IsNullable = true)]
    ...
    public class ClassStudentSubjectTaskMark : DbDataModel
    {
    ...
    public class ClassStudentSubjectTaskMarkDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(ClassStudentSubjectTaskMark));
        private bool _isAuditLog = false;
        private const string p_ClassSubjectTaskID = "@p_ClassSubjectTaskID";
        private const string p_StudentID = "@p_StudentID";
        public ClassStudentSubjectTaskMarkDao() { }
        public ClassStudentSubjectTaskMarkDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public ClassStudentSubjectTaskMark Get(Int32 ClassSubjectTaskID, Int32 StudentID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_ClassSubjectTaskID, ClassSubjectTaskID);
            _ctx.Add(p_StudentID, StudentID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (ClassStudentSubjectTaskMark)_helper.DataRowToObject(row, new ClassStudentSubjectTaskMark());
        }
        public int Insert(ClassStudentSubjectTaskMark record)
        {
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(ClassStudentSubjectTaskMark record)
        {
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
    ...
    #region CoverageType
    [Serializable]
    [Table(Name = "CoverageType")]
    public class CoverageType : DbDataModel
    {
        ...
        [Column(Name = "CoverageTypeID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 CoverageTypeID
        {
            get { return _CoverageTypeID; }
            set { _CoverageTypeID = value; }
        }
        [Column(Name = "CoverageTypeCode", DataType = "String")]
        public String CoverageTypeCode
        {
            get { return _CoverageTypeCode; }
            set { _CoverageTypeCode = value; }
        }
    ...
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(CoverageType));
        private bool _isAuditLog = false;
        private const string p_CoverageTypeID = "@p_CoverageTypeID";
        public CoverageTypeDao() { }
        public CoverageTypeDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public CoverageType Get(Int32 CoverageTypeID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_CoverageTypeID, CoverageTypeID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (CoverageType)_helper.DataRowToObject(row, new CoverageType());
        }
        public int Insert(CoverageType record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(CoverageType record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 CoverageTypeID)
        {
            CoverageType record;
            if (_ctx.Transaction == null)
                record = new CoverageTypeDao().Get(CoverageTypeID);
            else
                record = Get(CoverageTypeID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "Customer")]
    public class Customer : DbDataModel
    {
        private Int32 _BusinessPartnerID;
        ...
        [Column(Name = "CustomerBillTo", DataType = "Int32", IsNullable = true)]
        public Int32? CustomerBillTo
        {
            get { return _CustomerBillTo; }
            set { _CustomerBillTo = value; }
        }
        [Column(Name = "CreditLimit", DataType = "Decimal", IsNullable = true)]
        public Decimal CreditLimit
        {
            get { return _CreditLimit; }
            set { _CreditLimit = value; }
        }
        [Column(Name = "CreditBalance", DataType = "Decimal", IsNullable = true)]
        ...
        [Column(Name = "IsCreditHold", DataType = "Boolean", IsNullable = true)]
        public Boolean IsCreditHold
        {
            get { return _IsCreditHold; }
            set { _IsCreditHold = value; }
        }
        [Column(Name = "IsHasContract", DataType = "Boolean", IsNullable = true)]
        public Boolean IsHasContract
        {
            get { return _IsHasContract; }
            set { _IsHasContract = value; }
        }
        [Column(Name = "IsUsingDunningLetter", DataType = "Boolean", IsNullable = true)]
    ...
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(Customer));
        private bool _isAuditLog = false;
        private const string p_BusinessPartnerID = "@p_BusinessPartnerID";
        public CustomerDao() { }
        public CustomerDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public Customer Get(Int32 BusinessPartnerID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_BusinessPartnerID, BusinessPartnerID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (Customer)_helper.DataRowToObject(row, new Customer());
        }
        ...
        public int Delete(Int32 BusinessPartnerID)
        {
            Customer record;
            if (_ctx.Transaction == null)
                record = new CustomerDao().Get(BusinessPartnerID);
            else
                record = Get(BusinessPartnerID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
    ...
    public class OrganizationDt : DbDataModel
    {
        ...
        [Column(Name = "OrganizationDtID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
    ...
    public class OrganizationDtDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(OrganizationDt));
        private bool _isAuditLog = false;
        private const string p_OrganizationDtID = "@p_OrganizationDtID";
        public OrganizationDtDao() { }
        public OrganizationDtDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public OrganizationDt Get(Int32 OrganizationDtID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_OrganizationDtID, OrganizationDtID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (OrganizationDt)_helper.DataRowToObject(row, new OrganizationDt());
        }
        public int Insert(OrganizationDt record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(OrganizationDt record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 OrganizationDtID)
        {
            OrganizationDt record;
            if (_ctx.Transaction == null)
                record = new OrganizationDtDao().Get(OrganizationDtID);
            else
                record = Get(OrganizationDtID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "OrganizationDtStudent")]
    public class OrganizationDtStudent : DbDataModel
    {
        private Int32 _OrganizationDtID;
        private Int32 _StudentID;

        [Column(Name = "OrganizationDtID", DataType = "Int32", IsPrimaryKey = true)]
        public Int32 OrganizationDtID
        {
            get { return _OrganizationDtID; }
            set { _OrganizationDtID = value; }
    ...
    public class OrganizationDtStudentDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(OrganizationDtStudent));
        private bool _isAuditLog = false;
        private const string p_OrganizationDtID = "@p_OrganizationDtID";
        private const string p_StudentID = "@p_StudentID";
        public OrganizationDtStudentDao() { }
        public OrganizationDtStudentDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public OrganizationDtStudent Get(Int32 OrganizationDtID, Int32 StudentID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_OrganizationDtID, OrganizationDtID);
            _ctx.Add(p_StudentID, StudentID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (OrganizationDtStudent)_helper.DataRowToObject(row, new OrganizationDtStudent());
        }
        public int Insert(OrganizationDtStudent record)
        {
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(OrganizationDtStudent record)
        {
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 OrganizationDtID, Int32 StudentID)
        {
            OrganizationDtStudent record;
            if (_ctx.Transaction == null)
                record = new OrganizationDtStudentDao().Get(OrganizationDtID, StudentID);
            else
                record = Get(OrganizationDtID, StudentID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "OrganizationHd")]
    public class OrganizationHd : DbDataModel
    {
        private Int32 _OrganizationID;
        private String _OrganizationCode;
        private String _OrganizationName;
        private Boolean _IsAllStudentAsMember;
        private Int32 _SchoolPeriodID;
        private String _Remarks;
        private Boolean _IsDeleted;
        private Int32? _CreatedBy;
        ...
        [Column(Name = "OrganizationID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 OrganizationID
        {
            get { return _OrganizationID; }
            set { _OrganizationID = value; }
        }
        [Column(Name = "OrganizationCode", DataType = "String")]
        ...
        [Column(Name = "IsAllStudentAsMember", DataType = "Boolean")]
        public Boolean IsAllStudentAsMember
        {
            get { return _IsAllStudentAsMember; }
            set { _IsAllStudentAsMember = value; }
        }
        [Column(Name = "SchoolPeriodID", DataType = "Int32")]
        public Int32 SchoolPeriodID
        {
    ...
    public class OrganizationHdDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(OrganizationHd));
        private bool _isAuditLog = false;
        private const string p_OrganizationID = "@p_OrganizationID";
        public OrganizationHdDao() { }
        public OrganizationHdDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public OrganizationHd Get(Int32 OrganizationID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_OrganizationID, OrganizationID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (OrganizationHd)_helper.DataRowToObject(row, new OrganizationHd());
        }
        public int Insert(OrganizationHd record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(OrganizationHd record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 OrganizationID)
        {
            OrganizationHd record;
            if (_ctx.Transaction == null)
    ...
    public class Registration : DbDataModel
    {
        ...
        [Column(Name = "AdmissionFeeRuleID", DataType = "Int32", IsNullable = true)]
        public Int32? AdmissionFeeRuleID
        {
            get { return _AdmissionFeeRuleID; }
            set { _AdmissionFeeRuleID = value; }
    ...
    public class SchoolGradeDao
    {
        ...
        public int Insert(SchoolGrade record)
        {
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(SchoolGrade record)
        {
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
    ...
    public class StudentFee : DbDataModel
    {
    ...
    public class StudentFeeComp : DbDataModel
    {
        ...
        [Column(Name = "StudentFeeCompID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 StudentFeeCompID
        {
            get { return _StudentFeeCompID; }
            set { _StudentFeeCompID = value; }
    ...
    public class StudentFeeCompDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(StudentFeeComp));
        private bool _isAuditLog = false;
        private const string p_StudentFeeCompID = "@p_StudentFeeCompID";
        public StudentFeeCompDao() { }
        public StudentFeeCompDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public StudentFeeComp Get(Int32 StudentFeeCompID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_StudentFeeCompID, StudentFeeCompID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (StudentFeeComp)_helper.DataRowToObject(row, new StudentFeeComp());
        }
        public int Insert(StudentFeeComp record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(StudentFeeComp record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 StudentFeeCompID)
        {
            StudentFeeComp record;
            if (_ctx.Transaction == null)
                record = new StudentFeeCompDao().Get(StudentFeeCompID);
            else
                record = Get(StudentFeeCompID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    public class StudentFeeCompTypePayment : DbDataModel
    {
        private Int32 _StudentFeeCompTypePaymentID;
        private Int32 _StudentFeeCompTypeID;
        private Int16 _DisplayOrder;
        private Int32? _PaymentDate;
        private Int32? _PaymentMonth;
        private Decimal _PaymentAmountPercentage;
        private Boolean _IsDeleted;
        private Int32? _CreatedBy;
        private DateTime _CreatedDate;
        private Int32? _LastUpdatedBy;
        ...
        [Column(Name = "StudentFeeCompTypePaymentID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 StudentFeeCompTypePaymentID
        {
            get { return _StudentFeeCompTypePaymentID; }
            set { _StudentFeeCompTypePaymentID = value; }
        }
        [Column(Name = "StudentFeeCompTypeID", DataType = "Int32")]
        public Int32 StudentFeeCompTypeID
        {
        ...
        [Column(Name = "PaymentAmountPercentage", DataType = "Decimal", IsNullable = true)]
        public Decimal PaymentAmountPercentage
        {
            get { return _PaymentAmountPercentage; }
            set { _PaymentAmountPercentage = value; }
        }
        [Column(Name = "IsDeleted", DataType = "Boolean")]
        public Boolean IsDeleted
        {
    ...
    public class StudentFeeCompTypePaymentDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(StudentFeeCompTypePayment));
        private bool _isAuditLog = false;
        private const string p_StudentFeeCompTypePaymentID = "@p_StudentFeeCompTypePaymentID";
        public StudentFeeCompTypePaymentDao() { }
        public StudentFeeCompTypePaymentDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public StudentFeeCompTypePayment Get(Int32 StudentFeeCompTypePaymentID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_StudentFeeCompTypePaymentID, StudentFeeCompTypePaymentID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (StudentFeeCompTypePayment)_helper.DataRowToObject(row, new StudentFeeCompTypePayment());
        }
        public int Insert(StudentFeeCompTypePayment record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(StudentFeeCompTypePayment record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 StudentFeeCompTypePaymentID)
        {
            StudentFeeCompTypePayment record;
            if (_ctx.Transaction == null)
                record = new StudentFeeCompTypePaymentDao().Get(StudentFeeCompTypePaymentID);
            else
                record = Get(StudentFeeCompTypePaymentID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    #region StudentFeeDt
    [Serializable]
    [Table(Name = "StudentFeeDt")]
    public partial class StudentFeeDt : DbDataModel
    {
        private Int32 _StudentFeeDtID;
        private Int32 _StudentFeeID;
        private Int16 _DisplayOrder;
        ...
        [Column(Name = "StudentFeeDtID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 StudentFeeDtID
        {
            get { return _StudentFeeDtID; }
            set { _StudentFeeDtID = value; }
        ...
        [Column(Name = "TransactionAmount", DataType = "Decimal", IsNullable = true)]
        public Decimal TransactionAmount
        {
            get { return _TransactionAmount; }
            set { _TransactionAmount = value; }
    ...
    public class StudentFeeDtDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(StudentFeeDt));
        private bool _isAuditLog = false;
        private const string p_StudentFeeDtID = "@p_StudentFeeDtID";
        public StudentFeeDtDao() { }
        public StudentFeeDtDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public StudentFeeDt Get(Int32 StudentFeeDtID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_StudentFeeDtID, StudentFeeDtID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (StudentFeeDt)_helper.DataRowToObject(row, new StudentFeeDt());
        }
        public int Insert(StudentFeeDt record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(StudentFeeDt record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 StudentFeeDtID)
        {
            StudentFeeDt record;
            if (_ctx.Transaction == null)
                record = new StudentFeeDtDao().Get(StudentFeeDtID);
            else
                record = Get(StudentFeeDtID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "StudentFinalMarkFormulaDt")]
    public class StudentFinalMarkFormulaDt : DbDataModel
    {
        private Int32 _StudentFinalMarkFormulaDtID;
        ...
        [Column(Name = "StudentFinalMarkFormulaDtID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 StudentFinalMarkFormulaDtID
        {
            get { return _StudentFinalMarkFormulaDtID; }
            set { _StudentFinalMarkFormulaDtID = value; }
    ...
    public class StudentFinalMarkFormulaDtDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(StudentFinalMarkFormulaDt));
        private bool _isAuditLog = false;
        private const string p_StudentFinalMarkFormulaDtID = "@p_StudentFinalMarkFormulaDtID";
        public StudentFinalMarkFormulaDtDao() { }
        public StudentFinalMarkFormulaDtDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public StudentFinalMarkFormulaDt Get(Int32 StudentFinalMarkFormulaDtID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_StudentFinalMarkFormulaDtID, StudentFinalMarkFormulaDtID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (StudentFinalMarkFormulaDt)_helper.DataRowToObject(row, new StudentFinalMarkFormulaDt());
        }
        public int Insert(StudentFinalMarkFormulaDt record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(StudentFinalMarkFormulaDt record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 StudentFinalMarkFormulaDtID)
        {
            StudentFinalMarkFormulaDt record;
            if (_ctx.Transaction == null)
                record = new StudentFinalMarkFormulaDtDao().Get(StudentFinalMarkFormulaDtID);
            else
                record = Get(StudentFinalMarkFormulaDtID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "StudentFinalMarkFormulaDtTaskType")]
    public class StudentFinalMarkFormulaDtTaskType : DbDataModel
    {
        private Int32 _StudentFinalMarkFormulaDtID;
        private String _GCTaskType;
        ...
        [Column(Name = "GCTaskType", DataType = "String", IsPrimaryKey = true)]
        public String GCTaskType
        {
            get { return _GCTaskType; }
            set { _GCTaskType = value; }
    ...
    public class StudentFinalMarkFormulaDtTaskTypeDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(StudentFinalMarkFormulaDtTaskType));
        private bool _isAuditLog = false;
        private const string p_GCTaskType = "@p_GCTaskType";
        private const string p_StudentFinalMarkFormulaDtID = "@p_StudentFinalMarkFormulaDtID";
        public StudentFinalMarkFormulaDtTaskTypeDao() { }
        public StudentFinalMarkFormulaDtTaskTypeDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public StudentFinalMarkFormulaDtTaskType Get(Int32 StudentFinalMarkFormulaDtID, String GCTaskType)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_GCTaskType, GCTaskType);
            _ctx.Add(p_StudentFinalMarkFormulaDtID, StudentFinalMarkFormulaDtID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (StudentFinalMarkFormulaDtTaskType)_helper.DataRowToObject(row, new StudentFinalMarkFormulaDtTaskType());
        }
        public int Insert(StudentFinalMarkFormulaDtTaskType record)
        {
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(StudentFinalMarkFormulaDtTaskType record)
        {
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 StudentFinalMarkFormulaDtID, String GCTaskType)
        {
            StudentFinalMarkFormulaDtTaskType record;
            if (_ctx.Transaction == null)
                record = new StudentFinalMarkFormulaDtTaskTypeDao().Get(StudentFinalMarkFormulaDtID, GCTaskType);
            else
                record = Get(StudentFinalMarkFormulaDtID, GCTaskType);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "StudentFinalMarkFormulaHd")]
    public class StudentFinalMarkFormulaHd : DbDataModel
    {
        private Int32 _StudentFinalMarkFormulaID;
        private String _SiteID;
        private String _StudentFinalMarkFormulaCode;
        private String _StudentFinalMarkFormulaName;
        private String _Remarks;
        private Boolean _IsDeleted;
        private Int32? _CreatedBy;
        private DateTime _CreatedDate;
        ...
        [Column(Name = "StudentFinalMarkFormulaID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 StudentFinalMarkFormulaID
        {
            get { return _StudentFinalMarkFormulaID; }
            set { _StudentFinalMarkFormulaID = value; }
        ...
        [Column(Name = "StudentFinalMarkFormulaCode", DataType = "String")]
        public String StudentFinalMarkFormulaCode
        {
            get { return _StudentFinalMarkFormulaCode; }
            set { _StudentFinalMarkFormulaCode = value; }
        }
        [Column(Name = "StudentFinalMarkFormulaName", DataType = "String")]
        public String StudentFinalMarkFormulaName
        {
            get { return _StudentFinalMarkFormulaName; }
            set { _StudentFinalMarkFormulaName = value; }
        }
        [Column(Name = "Remarks", DataType = "String")]
        public String Remarks
        {
    ...
    public class StudentFinalMarkFormulaHdDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(StudentFinalMarkFormulaHd));
        private bool _isAuditLog = false;
        private const string p_StudentFinalMarkFormulaID = "@p_StudentFinalMarkFormulaID";
        public StudentFinalMarkFormulaHdDao() { }
        public StudentFinalMarkFormulaHdDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public StudentFinalMarkFormulaHd Get(Int32 StudentFinalMarkFormulaID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_StudentFinalMarkFormulaID, StudentFinalMarkFormulaID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (StudentFinalMarkFormulaHd)_helper.DataRowToObject(row, new StudentFinalMarkFormulaHd());
        }
        public int Insert(StudentFinalMarkFormulaHd record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(StudentFinalMarkFormulaHd record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 StudentFinalMarkFormulaID)
        {
            StudentFinalMarkFormulaHd record;
            if (_ctx.Transaction == null)
                record = new StudentFinalMarkFormulaHdDao().Get(StudentFinalMarkFormulaID);
            else
                record = Get(StudentFinalMarkFormulaID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "StudentProgressRuleDt")]
    public partial class StudentProgressRuleDt : DbDataModel
    {
        private Int32 _StudentProgressRuleDtID;
        private Int32 _StudentProgressRuleID;
        ...
        private Boolean _IsFromPassingGrade;
        private Decimal _ToValue;
        private Boolean _IsToPassingGrade;
        private String _Remarks;
        private Boolean _IsDeleted;
        private Int32? _CreatedBy;
        private DateTime _CreatedDate;
        ...
        [Column(Name = "StudentProgressRuleDtID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 StudentProgressRuleDtID
        {
            get { return _StudentProgressRuleDtID; }
            set { _StudentProgressRuleDtID = value; }
        ...
        [Column(Name = "FromValue", DataType = "Decimal")]
        public Decimal FromValue
        {
            get { return _FromValue; }
            set { _FromValue = value; }
        }
        [Column(Name = "IsFromPassingGrade", DataType = "Boolean")]
        public Boolean IsFromPassingGrade
        {
            get { return _IsFromPassingGrade; }
            set { _IsFromPassingGrade = value; }
        }
        [Column(Name = "ToValue", DataType = "Decimal")]
        public Decimal ToValue
        {
            get { return _ToValue; }
            set { _ToValue = value; }
        }
        [Column(Name = "IsToPassingGrade", DataType = "Boolean")]
        public Boolean IsToPassingGrade
        {
            get { return _IsToPassingGrade; }
            set { _IsToPassingGrade = value; }
        }
        [Column(Name = "Remarks", DataType = "String")]
        public String Remarks
        {
    ...
    public class StudentProgressRuleDtDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(StudentProgressRuleDt));
        private bool _isAuditLog = false;
        private const string p_StudentProgressRuleDtID = "@p_StudentProgressRuleDtID";
        public StudentProgressRuleDtDao() { }
        public StudentProgressRuleDtDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public StudentProgressRuleDt Get(Int32 StudentProgressRuleDtID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_StudentProgressRuleDtID, StudentProgressRuleDtID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (StudentProgressRuleDt)_helper.DataRowToObject(row, new StudentProgressRuleDt());
        }
        public int Insert(StudentProgressRuleDt record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(StudentProgressRuleDt record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 StudentProgressRuleDtID)
        {
            StudentProgressRuleDt record;
            if (_ctx.Transaction == null)
                record = new StudentProgressRuleDtDao().Get(StudentProgressRuleDtID);
            else
                record = Get(StudentProgressRuleDtID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "StudentProgressRuleHd")]
    public class StudentProgressRuleHd : DbDataModel
    {
        private Int32 _StudentProgressRuleID;
        private String _SiteID;
        private String _StudentProgressRuleCode;
        private String _StudentProgressRuleName;
        private String _Remarks;
        private Boolean _IsDeleted;
        private Int32? _CreatedBy;
        private DateTime _CreatedDate;
        ...
        [Column(Name = "StudentProgressRuleID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 StudentProgressRuleID
        {
            get { return _StudentProgressRuleID; }
            set { _StudentProgressRuleID = value; }
        ...
        [Column(Name = "StudentProgressRuleCode", DataType = "String")]
        public String StudentProgressRuleCode
        {
            get { return _StudentProgressRuleCode; }
            set { _StudentProgressRuleCode = value; }
        }
        [Column(Name = "StudentProgressRuleName", DataType = "String")]
        public String StudentProgressRuleName
        {
            get { return _StudentProgressRuleName; }
            set { _StudentProgressRuleName = value; }
        }
        [Column(Name = "Remarks", DataType = "String")]
        public String Remarks
        {
    ...
    public class StudentProgressRuleHdDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(StudentProgressRuleHd));
        private bool _isAuditLog = false;
        private const string p_StudentProgressRuleID = "@p_StudentProgressRuleID";
        public StudentProgressRuleHdDao() { }
        public StudentProgressRuleHdDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public StudentProgressRuleHd Get(Int32 StudentProgressRuleID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_StudentProgressRuleID, StudentProgressRuleID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (StudentProgressRuleHd)_helper.DataRowToObject(row, new StudentProgressRuleHd());
        }
        public int Insert(StudentProgressRuleHd record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(StudentProgressRuleHd record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 StudentProgressRuleID)
        {
            StudentProgressRuleHd record;
            if (_ctx.Transaction == null)
                record = new StudentProgressRuleHdDao().Get(StudentProgressRuleID);
            else
                record = Get(StudentProgressRuleID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "SubjectBasicCompetency")]
    public class SubjectBasicCompetency : DbDataModel
    {
        ...
        [Column(Name = "SubjectBasicCompetencyID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        ...
        [Column(Name = "StudySource", DataType = "String", IsNullable = true)]
    ...
    public class SubjectBasicCompetencyDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(SubjectBasicCompetency));
        private bool _isAuditLog = false;
        private const string p_SubjectBasicCompetencyID = "@p_SubjectBasicCompetencyID";
        public SubjectBasicCompetencyDao() { }
        public SubjectBasicCompetencyDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public SubjectBasicCompetency Get(Int32 SubjectBasicCompetencyID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_SubjectBasicCompetencyID, SubjectBasicCompetencyID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (SubjectBasicCompetency)_helper.DataRowToObject(row, new SubjectBasicCompetency());
        }
        public int Insert(SubjectBasicCompetency record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(SubjectBasicCompetency record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 SubjectBasicCompetencyID)
        {
            SubjectBasicCompetency record;
            if (_ctx.Transaction == null)
                record = new SubjectBasicCompetencyDao().Get(SubjectBasicCompetencyID);
            else
                record = Get(SubjectBasicCompetencyID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "SubjectCompetencyStandard")]
    public class SubjectCompetencyStandard : DbDataModel
    {
        private Int32 _SubjectCompetencyStandardID;
        private Int32 _SubjectMatterID;
        private String _GCPeriodSection;
        ...
        [Column(Name = "SubjectCompetencyStandardID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 SubjectCompetencyStandardID
        {
            get { return _SubjectCompetencyStandardID; }
            set { _SubjectCompetencyStandardID = value; }
    ...
    public class SubjectCompetencyStandardDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(SubjectCompetencyStandard));
        private bool _isAuditLog = false;
        private const string p_SubjectCompetencyStandardID = "@p_SubjectCompetencyStandardID";
        public SubjectCompetencyStandardDao() { }
        public SubjectCompetencyStandardDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public SubjectCompetencyStandard Get(Int32 SubjectCompetencyStandardID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_SubjectCompetencyStandardID, SubjectCompetencyStandardID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (SubjectCompetencyStandard)_helper.DataRowToObject(row, new SubjectCompetencyStandard());
        }
        public int Insert(SubjectCompetencyStandard record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(SubjectCompetencyStandard record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 SubjectCompetencyStandardID)
        {
            SubjectCompetencyStandard record;
            if (_ctx.Transaction == null)
                record = new SubjectCompetencyStandardDao().Get(SubjectCompetencyStandardID);
            else
                record = Get(SubjectCompetencyStandardID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
    ...
    [Serializable]
    [Table(Name = "SubjectCompetencyStandardSummary")]
    public class SubjectCompetencyStandardSummary : DbDataModel
    {
        private Int32 _SubjectCompetencyStandardSummaryID;
        private Int32 _SubjectMatterID;
        private String _GCPeriodSection;
        ...
        [Column(Name = "SubjectCompetencyStandardSummaryID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 SubjectCompetencyStandardSummaryID
        {
            get { return _SubjectCompetencyStandardSummaryID; }
            set { _SubjectCompetencyStandardSummaryID = value; }
        }
        [Column(Name = "SubjectMatterID", DataType = "Int32")]
        public Int32 SubjectMatterID
        {
        ...
        [Column(Name = "SummaryName", DataType = "String")]
    ...
    public class SubjectCompetencyStandardSummaryDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(SubjectCompetencyStandardSummary));
        private bool _isAuditLog = false;
        private const string p_SubjectCompetencyStandardSummaryID = "@p_SubjectCompetencyStandardSummaryID";
        public SubjectCompetencyStandardSummaryDao() { }
        public SubjectCompetencyStandardSummaryDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public SubjectCompetencyStandardSummary Get(Int32 SubjectCompetencyStandardSummaryID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_SubjectCompetencyStandardSummaryID, SubjectCompetencyStandardSummaryID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (SubjectCompetencyStandardSummary)_helper.DataRowToObject(row, new SubjectCompetencyStandardSummary());
        }
        public int Insert(SubjectCompetencyStandardSummary record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(SubjectCompetencyStandardSummary record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 SubjectCompetencyStandardSummaryID)
        {
            SubjectCompetencyStandardSummary record;
            if (_ctx.Transaction == null)
    ...
    public class SubjectMeetingPlanHd : DbDataModel
    {
        private Int32 _SubjectMeetingPlanHdID;
        private Int32 _SubjectMatterID;
        private String _GCPeriodSection;
        ...
        [Column(Name = "SubjectMeetingPlanHdID", DataType = "Int32", IsPrimaryKey = true, IsIdentity = true)]
        public Int32 SubjectMeetingPlanHdID
        {
            get { return _SubjectMeetingPlanHdID; }
            set { _SubjectMeetingPlanHdID = value; }
    ...
    public class SubjectMeetingPlanHdDao
    {
        private readonly IDbContext _ctx = DbFactory.Configure();
        private readonly DbHelper _helper = new DbHelper(typeof(SubjectMeetingPlanHd));
        private bool _isAuditLog = false;
        private const string p_SubjectMeetingPlanHdID = "@p_SubjectMeetingPlanHdID";
        public SubjectMeetingPlanHdDao() { }
        public SubjectMeetingPlanHdDao(IDbContext ctx)
        {
            _ctx = ctx;
        }
        public SubjectMeetingPlanHd Get(Int32 SubjectMeetingPlanHdID)
        {
            _ctx.CommandText = _helper.GetRecord();
            _ctx.Add(p_SubjectMeetingPlanHdID, SubjectMeetingPlanHdID);
            DataRow row = DaoBase.GetDataRow(_ctx);
            return (row == null) ? null : (SubjectMeetingPlanHd)_helper.DataRowToObject(row, new SubjectMeetingPlanHd());
        }
        public int Insert(SubjectMeetingPlanHd record)
        {
            record.CreatedDate = DateTime.Now;
            _helper.Insert(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
        public int Update(SubjectMeetingPlanHd record)
        {
            record.LastUpdatedDate = DateTime.Now;
            _helper.Update(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx, true);
        }
        public int Delete(Int32 SubjectMeetingPlanHdID)
        {
            SubjectMeetingPlanHd record;
            if (_ctx.Transaction == null)
                record = new SubjectMeetingPlanHdDao().Get(SubjectMeetingPlanHdID);
            else
                record = Get(SubjectMeetingPlanHdID);
            _helper.Delete(_ctx, record, _isAuditLog);
            return DaoBase.ExecuteNonQuery(_ctx);
        }
    }
