...
namespace CodeX.Muses.Web.TeacherPage.Program
{
    public partial class ClassMeetingPageLauncher : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            List<GetUserMenuAccess> lstMenu = BusinessLayer.GetUserMenuAccess(Constant.Module.TEACHER_PAGE, AppSession.UserLogin.SiteID, AppSession.UserLogin.UserID, filterExpression);
            ...
            lstMenu = BusinessLayer.GetUserMenuAccess(Constant.Module.TEACHER_PAGE, AppSession.UserLogin.SiteID, AppSession.UserLogin.UserID, filterExpression);
