<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLProductLineDtEntryCtl.ascx.cs" 
    Inherits="CodeX.Web.Accounting.Program.GLProductLineDtEntryCtl" %>
            ...
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent" style="width:50%">
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtProductLineCode" ReadOnly="true" Width="120px" runat="server" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <table width="100%">
                                ...
                                <tr>
                                    <td class="tdLabel"><label class="lblLink" id="lblInventoryVAT"><%=GetLabel("COA Persediaan (PPN)")%></label></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="tdLabel"><label class="lblLink" id="lblInventoryDiscount"><%=GetLabel("COA Persediaan (Diskon)")%></label></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="tdLabel"><label class="lblLink" id="lblAdjustmentIN"><%=GetLabel("COA Selisih Persediaan (IN)")%></label></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="tdLabel"><label class="lblLink" id="lblAdjustmentOUT"><%=GetLabel("COA Selisih Persediaan (OUT)")%></label></td>
                                    <td>
