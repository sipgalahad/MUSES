<%@ Page Title="" Language="C#" MasterPageFile="~/libs/MasterPage/MPEntry.master" AutoEventWireup="true" 
    CodeBehind="GLAPPaymentEntry.aspx.cs" Inherits="CodeX.Muses.Web.Accounting.Program.GLAPPaymentEntry" %>
            ...
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent" style="width:50%">
                    ...
                    <tr>
                        ...
                        <td>
                            <dxe:ASPxComboBox ID="cboSupplierPaymentMethod" ClientInstanceName="cboSupplierPaymentMethod" runat="server" Width="300px">
                    ...
                    <tr id="trBank" runat="server">
                        ...
                        <td><dxe:ASPxComboBox ID="cboBank" runat="server" Width="300px" /></td>
                    </tr>
                    <tr>
