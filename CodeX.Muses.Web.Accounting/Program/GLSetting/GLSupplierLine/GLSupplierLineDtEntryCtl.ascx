<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GLSupplierLineDtEntryCtl.ascx.cs" 
    Inherits="CodeX.Web.Accounting.Program.GLSupplierLineDtEntryCtl" %>
            ...
            <td style="padding:5px;vertical-align:top">
                <table class="tblEntryContent" style="width:50%">
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtSupplierLineCode" ReadOnly="true" Width="120px" runat="server" /></td>
                    </tr>
                    <tr>
                        <td class="tdLabel"><label class="lblMandatory"><%=GetLabel("Name")%></label></td>
                        <td><asp:TextBox ID="txtSupplierLineName" ReadOnly="true" Width="300px" runat="server" /></td>
                    </tr>
                    <tr>
