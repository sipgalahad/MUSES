<%@ Page Title="" Language="C#" MasterPageFile="~/Libs/MasterPage/MPList.master"
    AutoEventWireup="true" CodeBehind="UnbalanceJournalInformation.aspx.cs" Inherits="Codex.Ronin.Web.Accounting.Program.UnbalanceJournalInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plhList" runat="server">
    ...
    <div>
        ...
        <table width="100%">
            ...
            <tr>
                <td class="tdLabel"><%=GetLabel("Sumber Data") %></td>
                <td><dxe:ASPxComboBox runat="server" ID="cboDataSource" ClientInstanceName="cboDataSource" Width="350px" /></td>
                <td colspan="2"><input type="button" id="btnProcess" value="Refresh" /></td>
            </tr>
            <tr>
                <td />
                <td />
                                ...
                                <asp:Panel runat="server" ID="pnlView" Style="width: 100%; margin-left: auto; margin-right: auto;
                                    ...
                                    <asp:GridView ID="grdView" runat="server" CssClass="grdView notAllowSelect"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Selisih" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N}" HeaderStyle-Width="100px" HeaderText="Selisih" />
                                        </Columns>
                                        <EmptyDataTemplate>
